...
export interface NeoplasticEntityFilters { 
    ...
    /**
     * Related primary neoplasm - Filter for entries where at least one reference matches the query
     */
    'relatedPrimaryId.anyOf'?: Array<string>;
    /**
     * Related primary neoplasm - Filter for entries where at least one reference mismatches the query
     */
