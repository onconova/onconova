...
import {
    ...
    GetAllRiskAssessmentHistoryEventsRequestParams,
    GetRiskAssessmentByIdRequestParams,
    GetRiskAssessmentHistoryEventByIdRequestParams,
    GetRiskAssessmentsRequestParams,
    RevertRiskAssessmentToHistoryEventRequestParams,
...
export class RiskAssessmentsService extends BaseService implements RiskAssessmentsServiceInterface {
    ...
    public getAllRiskAssessmentHistoryEvents(requestParameters: GetAllRiskAssessmentHistoryEventsRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        const riskAssessmentId = requestParameters?.riskAssessmentId;
        if (riskAssessmentId === null || riskAssessmentId === undefined) {
            throw new Error('Required parameter riskAssessmentId was null or undefined when calling getAllRiskAssessmentHistoryEvents.');
        }
    ...
    public getRiskAssessmentHistoryEventById(requestParameters: GetRiskAssessmentHistoryEventByIdRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        const riskAssessmentId = requestParameters?.riskAssessmentId;
        if (riskAssessmentId === null || riskAssessmentId === undefined) {
            throw new Error('Required parameter riskAssessmentId was null or undefined when calling getRiskAssessmentHistoryEventById.');
        }
        const eventId = requestParameters?.eventId;
        if (eventId === null || eventId === undefined) {
            throw new Error('Required parameter eventId was null or undefined when calling getRiskAssessmentHistoryEventById.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public revertRiskAssessmentToHistoryEvent(requestParameters: RevertRiskAssessmentToHistoryEventRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<ModifiedResource>;
    public revertRiskAssessmentToHistoryEvent(requestParameters: RevertRiskAssessmentToHistoryEventRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<ModifiedResource>>;
    public revertRiskAssessmentToHistoryEvent(requestParameters: RevertRiskAssessmentToHistoryEventRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<ModifiedResource>>;
    public revertRiskAssessmentToHistoryEvent(requestParameters: RevertRiskAssessmentToHistoryEventRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        const riskAssessmentId = requestParameters?.riskAssessmentId;
        if (riskAssessmentId === null || riskAssessmentId === undefined) {
            throw new Error('Required parameter riskAssessmentId was null or undefined when calling revertRiskAssessmentToHistoryEvent.');
        }
        const eventId = requestParameters?.eventId;
        if (eventId === null || eventId === undefined) {
            throw new Error('Required parameter eventId was null or undefined when calling revertRiskAssessmentToHistoryEvent.');
        }
