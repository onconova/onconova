...
const TourDriverConfig: Config = {
    ...
    steps: [
        ...
        { element: 'pop-project-search-item:nth-of-type(1)', popover: { 
        ...
        { element: 'pop-project-search-item:nth-of-type(1) .p-splitbutton-button', popover: { 
            side: "right", align: 'center', 
            ...
            onNextClick: (el, step, {config, state, driver}) => {
                const element = document.querySelector('pop-project-search-item:nth-of-type(1) .p-splitbutton-dropdown') as HTMLElement;
                if (element) {
                    element.click();
                }
                setTimeout(() => {
        ...
        { element: 'pop-project-search-item:nth-of-type(1) .p-tieredmenu-item:nth-of-type(1)', popover: { 
            side: "right", align: 'center', 
