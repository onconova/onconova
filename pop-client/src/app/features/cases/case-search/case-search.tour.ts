...
const TourDriverConfig: Config = {
    ...
    steps: [
        ...
        { element: 'pop-case-search-item:nth-of-type(1)', popover: { 
            side: "right", align: 'center', 
            title: 'Case Details',
            description: 'For each case matching your search criteria you will see a card containing the basic details of the case.', 
        }},
        { element: 'pop-case-search-item:nth-of-type(1) .p-splitbutton-button', popover: { 
            side: "right", align: 'center', 
            ...
            onNextClick: (el, step, {config, state, driver}) => {
                const element = document.querySelector('pop-case-search-item:nth-of-type(1) .p-splitbutton-dropdown') as HTMLElement;
                if (element) {
                    element.click();
                }
                setTimeout(() => {
        ...
        { element: 'pop-case-search-item:nth-of-type(1) .p-tieredmenu-item:nth-of-type(1)', popover: { 
            side: "right", align: 'center', 
        ...
        { element: 'pop-case-search-item:nth-of-type(1) .p-tieredmenu-item:nth-of-type(2)', popover: { 
            side: "right", align: 'center', 
            title: 'Exporting Cases',
            description: 'You can delete an erroneous patient case with this option.', 
        }},
        { element: 'pop-case-search-item:nth-of-type(1) .p-tieredmenu-item:nth-of-type(3)', popover: { 
            side: "right", align: 'center', 
