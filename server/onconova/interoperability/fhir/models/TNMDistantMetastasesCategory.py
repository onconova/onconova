# Code autogenerated by Fhircraft 0.3.4 on 2025-11-11 15:54:00.073312.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Element,Meta,Narrative,Resource,Extension,Identifier,Reference,CodeableConcept,Annotation,BackboneElement,Quantity,Range,Ratio,SampledData,Period
...
class OnconovaTNMDistantMetastasesCategoryUsCore(CodeableConcept):
    """
...
class OnconovaTNMDistantMetastasesCategoryReferenceRange(BackboneElement):
    """
...
class OnconovaTNMDistantMetastasesCategoryComponentReferenceRange(BackboneElement):
    """
...
class OnconovaTNMDistantMetastasesCategoryComponent(BackboneElement):
    """
    ...
    referenceRange: Optional[List[OnconovaTNMDistantMetastasesCategoryComponentReferenceRange]] = Field(
...
class OnconovaTNMDistantMetastasesCategory(FHIRBaseModel):
    """
...
This profile extends the base mCODE [TNMDistantMetastasesCategory profile](http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-tnm-distant-metastases-category) to include specific constraints and extensions relevant to Onconova.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-tnm-distant-metastases-category'], versionId="0.2.0"),
    )
    ...
    category: Optional[List[Annotated[Union[OnconovaTNMDistantMetastasesCategoryUsCore, CodeableConcept], Field(union_mode='left_to_right')]]] = Field(
    ...
    referenceRange: Optional[List[OnconovaTNMDistantMetastasesCategoryReferenceRange]] = Field(
        description="Not used in this profile",
        default=None,
    )
    ...
    component: Optional[List[OnconovaTNMDistantMetastasesCategoryComponent]] = Field(
