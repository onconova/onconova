# Code autogenerated by Fhircraft 0.4.1 on 2025-12-04 08:14:48.085774.
...
class OnconovaTNMDistantMetastasesCategoryUsCore(CodeableConcept, FHIRSliceModel):
    """
...
class OnconovaTNMDistantMetastasesCategoryComponent(BackboneElement):
    ...
    referenceRange: Optional[
        List[OnconovaTNMDistantMetastasesCategoryComponentReferenceRange]
    ] = Field(
...
class OnconovaTNMDistantMetastasesCategory(DomainResource):
    """
    ...
    **Conformance:**
    ...
    category: Optional[
        List[
            Annotated[
                Union[OnconovaTNMDistantMetastasesCategoryUsCore, CodeableConcept],
    ...
    referenceRange: Optional[
        List[OnconovaTNMDistantMetastasesCategoryReferenceRange]
    ] = Field(
        description="Not used in this profile",
        default=None,
    )
