# Code autogenerated by Fhircraft 0.4.1 on 2025-12-04 08:14:23.640628.
...
class OnconovaMicrosatelliteInstabilityLabCategory(CodeableConcept, FHIRSliceModel):
    """
...
class OnconovaMicrosatelliteInstabilityConclusionStringComponentReferenceRange(
    BackboneElement
):
    """
...
class OnconovaMicrosatelliteInstabilityConclusionString(
    ...
    referenceRange: Optional[
        List[OnconovaMicrosatelliteInstabilityConclusionStringComponentReferenceRange]
    ] = Field(
...
class OnconovaMicrosatelliteInstability(DomainResource):
    """
    ...
    **Conformance:**
    ...
    category: Optional[
        List[
            Annotated[
                Union[OnconovaMicrosatelliteInstabilityLabCategory, CodeableConcept],
                Field(union_mode="left_to_right"),
            ]
        ]
    ] = Field(
    ...
    referenceRange: Optional[List[OnconovaMicrosatelliteInstabilityReferenceRange]] = (
        Field(
            description="Not used in this profile",
            default=None,
        )
    ...
    component: Optional[
        List[
            Annotated[
                Union[
                    OnconovaMicrosatelliteInstabilityConclusionString, BackboneElement
                ],
                Field(union_mode="left_to_right"),
            ]
        ]
