# Code autogenerated by Fhircraft 0.3.3 on 2025-11-07 18:12:46.712344.
...
class OnconovaMicrosatelliteInstabilityLabCategory(CodeableConcept):
    """
...
class OnconovaMicrosatelliteInstabilityReferenceRange(BackboneElement):
    """
...
class OnconovaMicrosatelliteInstabilityConclusionStringComponentReferenceRange(BackboneElement):
    """
...
class OnconovaMicrosatelliteInstabilityConclusionString(BackboneElement):
    """
    Clinical Conclusion
    """
    extension: Optional[List[Extension]] = Field(
    ...
    referenceRange: Optional[List[OnconovaMicrosatelliteInstabilityConclusionStringComponentReferenceRange]] = Field(
...
class OnconovaMicrosatelliteInstability(FHIRBaseModel):
    """
...
This profile extends the GenomicsReporting IG [MicrosatelliteInstability profile](http://hl7.org/fhir/uv/genomics-reporting/StructureDefinition/msi) to include specific constraints and extensions relevant to Onconova.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-microsatellite-instability'], versionId="0.2.0"),
    )
    ...
    category: Optional[List[Annotated[Union[OnconovaMicrosatelliteInstabilityLabCategory, CodeableConcept], Field(union_mode='left_to_right')]]] = Field(
    ...
    referenceRange: Optional[List[OnconovaMicrosatelliteInstabilityReferenceRange]] = Field(
    ...
    component: Optional[List[Annotated[Union[OnconovaMicrosatelliteInstabilityConclusionString, BackboneElement], Field(union_mode='left_to_right')]]] = Field(
