# Code autogenerated by Fhircraft 0.3.1 on 2025-10-09 07:26:46.277087.
...
This profile extends the GenomicsReporting IG [MicrosatelliteInstability profile](http://hl7.org/fhir/uv/genomics-reporting/StructureDefinition/msi) to include specific constraints and extensions relevant to Onconova.
    ...
    code: CodeableConcept = Field(
        description="81695-9",
        default_factory=lambda: CodeableConcept(coding=[{'system': 'http://loinc.org', 'code': '81695-9'}]),
    )
    ...
    def FHIR_code_pattern_constraint(cls, value):    
        return validate_FHIR_element_pattern(cls, value, 
            pattern=CodeableConcept(coding=[{'system': 'http://loinc.org', 'code': '81695-9'}]),
        )
