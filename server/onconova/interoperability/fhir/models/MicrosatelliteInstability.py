# Code autogenerated by Fhircraft 0.5.0 on 2026-02-23 17:26:22.030918.
...
from fhircraft.fhir.resources.datatypes.R4.complex import Annotation, BackboneElement, CodeableConcept, Coding, Extension, Meta, Reference
...
class MSI(GenomicsBase):
    ...
    meta: Optional[Meta] = Field(
        title="Meta",
        description="Metadata about the resource.",
        default_factory=lambda: Meta(profile=['http://hl7.org/fhir/uv/genomics-reporting/StructureDefinition/msi']),
    )
    code: Optional[CodeableConcept] = Field(
        description="81695-9",
        default_factory=lambda: CodeableConcept(coding=[Coding(code="81695-9", system="http://loinc.org")]),
    )
    ...
    def FHIR_code_pattern_constraint(cls, value):    
        return validate_FHIR_element_pattern(cls, value, 
            pattern=CodeableConcept(coding=[Coding(code="81695-9", system="http://loinc.org")]),
        )
...
Observation resources representing a microsatellite instability obtained through genomic testing in the scope of Onconova SHALL conform to this profile. Any resource intended to conform to this profile SHOULD populate `meta.profile` accordingly. 
    ...
    meta: Optional[Meta] = Field(
        title="Meta",
        description="Metadata about the resource.",
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-microsatellite-instability']),
    )
