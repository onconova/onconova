# Code autogenerated by Fhircraft 0.3.3 on 2025-11-07 18:12:46.192015.
...
class OnconovaSecondaryCancerConditionClinicalStatus(CodeableConcept):
    """
...
class OnconovaSecondaryCancerConditionUsCore(CodeableConcept):
    """
...
class OnconovaSecondaryCancerConditionScreeningAssessment(CodeableConcept):
    """
...
class OnconovaSecondaryCancerConditionStage(BackboneElement):
    """
...
class OnconovaSecondaryCancerConditionEvidence(BackboneElement):
    """
    Not used in this profile
    """
...
It constrains the mCODE [SecondaryCancerCCondition profile](http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-secondary-cancer-condition) to constrain the terminologies of the cancer topography and morphology extensions to use exclusively ICD-O-3 codes.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-secondary-cancer-condition'], versionId="0.2.0"),
    )
    ...
    extension: Optional[List[Annotated[Union[ConditionAssertedDate, HistologyMorphologyBehavior, ConditionRelated, RecurrenceOf, Extension], Field(union_mode='left_to_right')]]] = Field(
        description="Extension",
        default=None,
    )
    ...
    clinicalStatus: Optional[OnconovaSecondaryCancerConditionClinicalStatus] = Field(
    ...
    category: Optional[List[Annotated[Union[OnconovaSecondaryCancerConditionUsCore, OnconovaSecondaryCancerConditionScreeningAssessment, CodeableConcept], Field(union_mode='left_to_right')]]] = Field(
    ...
    stage: Optional[List[OnconovaSecondaryCancerConditionStage]] = Field(
        description="Not used in this profile",
        default=None,
    )
    evidence: Optional[List[OnconovaSecondaryCancerConditionEvidence]] = Field(
        description="Not used in this profile",
        default=None,
    )
