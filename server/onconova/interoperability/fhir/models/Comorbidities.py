# Code autogenerated by Fhircraft 0.3.1 on 2025-10-09 07:26:55.099061.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Element,Meta,Narrative,Resource,Extension,CodeableConcept,Reference,Identifier,Period,Timing,Quantity,Annotation,BackboneElement,Range,Ratio,SampledData
...
class RelatedConditionAbsentReferenceRange(BackboneElement):
    """
...
class RelatedConditionAbsentComponent(BackboneElement):
    """
    Not used in this profile
    """
...
class RelatedConditionAbsent(FHIRBaseModel):
    """
...
The profile constrains the mCODE [Comorbidities profile](http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-comorbidities) to ensure consistent use of ICD-10 codes for documenting comorbid conditions, and to link the comorbidity information to the Onconova primary cancer condition profile. 
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='0.1.0', profile=['http://luisfabib.github.io/onconova/StructureDefinition/onconova-comorbidities']),
    )
    ...
    code: CodeableConcept = Field(
        ...
        default_factory=lambda: CodeableConcept(coding=[{'system': 'http://snomed.info/sct', 'code': '398192003'}]),
    )
    ...
    referenceRange: Optional[List[RelatedConditionAbsentReferenceRange]] = Field(
        description="Not used in this profile",
        default=None,
    )
    ...
    component: Optional[List[RelatedConditionAbsentComponent]] = Field(
        description="Not used in this profile",
        default=None,
    )
    ...
    def FHIR_code_pattern_constraint(cls, value):    
        return validate_FHIR_element_pattern(cls, value, 
            pattern=CodeableConcept(coding=[{'system': 'http://snomed.info/sct', 'code': '398192003'}]),
        )
