# Code autogenerated by Fhircraft 0.3.4 on 2025-11-11 15:54:06.589073.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Element,Meta,Narrative,Resource,Extension,CodeableConcept,Reference,Identifier,Coding,Quantity,Annotation,BackboneElement,Range,Ratio,SampledData,Period
...
The profile constrains the mCODE [Comorbidities profile](http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-comorbidities) to ensure consistent use of ICD-10 codes for documenting comorbid conditions, and to link the comorbidity information to the Onconova primary cancer condition profile. 
    ...
    referenceRange: Optional[List[OnconovaComorbiditiesReferenceRange]] = Field(
        description="Not used in this profile",
        default=None,
    )
    ...
    component: Optional[List[OnconovaComorbiditiesComponent]] = Field(
        description="Not used in this profile",
        default=None,
    )
