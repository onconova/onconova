# Code autogenerated by Fhircraft 0.4.1 on 2025-12-04 08:14:57.257382.
...
class HomologousRecombinationDeficiencyInterpretation(FHIRSliceModel):
    """
...
class OnconovaHomologousRecombinationDeficiencyLabCategory(
...
class OnconovaHomologousRecombinationDeficiencyConclusionStringComponentReferenceRange(
    BackboneElement
):
    """
...
class OnconovaHomologousRecombinationDeficiencyConclusionString(
    BackboneElement, FHIRSliceModel
):
    """
    Clinical Conclusion
    """
    ...
    referenceRange: Optional[
        List[
            OnconovaHomologousRecombinationDeficiencyConclusionStringComponentReferenceRange
        ]
    ] = Field(
...
class OnconovaHomologousRecombinationDeficiency(DomainResource):
    """
    ...
    **Conformance:**
    ...
    category: Optional[
        List[
            Annotated[
                Union[
                    OnconovaHomologousRecombinationDeficiencyLabCategory,
                    CodeableConcept,
                ],
                Field(union_mode="left_to_right"),
            ]
    ...
    referenceRange: Optional[
        List[OnconovaHomologousRecombinationDeficiencyReferenceRange]
    ] = Field(
        description="Not used in this profile",
        default=None,
    )
    ...
    component: Optional[
        List[
            Annotated[
                Union[
                    OnconovaHomologousRecombinationDeficiencyConclusionString,
                    BackboneElement,
                ],
                Field(union_mode="left_to_right"),
            ]
