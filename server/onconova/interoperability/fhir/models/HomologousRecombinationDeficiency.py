# Code autogenerated by Fhircraft 0.3.4 on 2025-11-11 15:54:02.778918.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Element,Meta,Narrative,Resource,Extension,CodeableConcept,Reference,Identifier,Coding,Quantity,Annotation,BackboneElement,Range
...
class OnconovaHomologousRecombinationDeficiencyLabCategory(CodeableConcept):
    """
...
class OnconovaHomologousRecombinationDeficiencyReferenceRange(BackboneElement):
    """
...
class OnconovaHomologousRecombinationDeficiencyConclusionStringComponentReferenceRange(BackboneElement):
    """
...
class OnconovaHomologousRecombinationDeficiencyConclusionString(BackboneElement):
    """
    Clinical Conclusion
    """
    extension: Optional[List[Extension]] = Field(
    ...
    referenceRange: Optional[List[OnconovaHomologousRecombinationDeficiencyConclusionStringComponentReferenceRange]] = Field(
...
class OnconovaHomologousRecombinationDeficiency(FHIRBaseModel):
    """
...
This profile extends the GenomicsReporting IG [GenomicsBase profile](http://hl7.org/fhir/uv/genomics-reporting/StructureDefinition/genomics-base) to include specific constraints and extensions relevant to Onconova.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-homologous-recombination-deficiency'], versionId="0.2.0"),
    )
    ...
    category: Optional[List[Annotated[Union[OnconovaHomologousRecombinationDeficiencyLabCategory, CodeableConcept], Field(union_mode='left_to_right')]]] = Field(
    ...
    referenceRange: Optional[List[OnconovaHomologousRecombinationDeficiencyReferenceRange]] = Field(
    ...
    component: Optional[List[Annotated[Union[OnconovaHomologousRecombinationDeficiencyConclusionString, BackboneElement], Field(union_mode='left_to_right')]]] = Field(
