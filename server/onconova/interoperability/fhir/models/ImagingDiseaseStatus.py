# Code autogenerated by Fhircraft 0.3.1 on 2025-10-09 07:26:56.179135.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Element,Meta,Narrative,Resource,Extension,CodeableConcept,Identifier,Reference,Annotation,BackboneElement,Quantity,Range,Ratio,SampledData,Period
...
class CancerDiseaseStatusEvidenceTypeReferenceRange(BackboneElement):
    """
...
class CancerDiseaseStatusEvidenceTypeComponent(BackboneElement):
    """
    Not used in this profile
    """
...
class CancerDiseaseStatusEvidenceType(FHIRBaseModel):
    """
...
It constrains the mCODE [CancerDiseaseStatus profile](http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-cancer-disease-status) to restrict it to imaging-based monitoring evaluated based on RECIST criteria.
    ...
    category: List[CodeableConcept] = Field(
        ...
        default=[CodeableConcept(coding=[Coding(system=http://terminology.hl7.org/CodeSystem/observation-category, display=Imaging, code=imaging)])],
    )
    code: CodeableConcept = Field(
        description="Type of observation (code / type)",
        default_factory=lambda: CodeableConcept(coding=[{'system': 'http://loinc.org', 'code': '97509-4'}]),
    )
    ...
    referenceRange: Optional[List[CancerDiseaseStatusEvidenceTypeReferenceRange]] = Field(
        description="Not used in this profile",
        default=None,
    )
    ...
    component: Optional[List[CancerDiseaseStatusEvidenceTypeComponent]] = Field(
        description="Not used in this profile",
        default=None,
    )
    ...
    def FHIR_category_pattern_constraint(cls, value):    
        return validate_FHIR_element_pattern(cls, value, 
            pattern=CodeableConcept(coding=[{'system': 'http://terminology.hl7.org/CodeSystem/observation-category', 'code': 'imaging', 'display': 'Imaging'}]),
        )
    ...
    def FHIR_code_pattern_constraint(cls, value):    
        return validate_FHIR_element_pattern(cls, value, 
            pattern=CodeableConcept(coding=[{'system': 'http://loinc.org', 'code': '97509-4'}]),
        )
