# Code autogenerated by Fhircraft 0.4.1 on 2025-12-04 08:14:52.311651.
...
class OnconovaTNMLymphaticInvasionCategoryUsCore(CodeableConcept, FHIRSliceModel):
    """
...
class OnconovaTNMLymphaticInvasionCategoryComponent(BackboneElement):
    ...
    referenceRange: Optional[
        List[OnconovaTNMLymphaticInvasionCategoryComponentReferenceRange]
    ] = Field(
...
class OnconovaTNMLymphaticInvasionCategory(DomainResource):
    """
    ...
    **Conformance:**
    ...
    category: Optional[
        List[
            Annotated[
                Union[OnconovaTNMLymphaticInvasionCategoryUsCore, CodeableConcept],
    ...
    referenceRange: Optional[
        List[OnconovaTNMLymphaticInvasionCategoryReferenceRange]
    ] = Field(
        description="Not used in this profile",
        default=None,
    )
