# Code autogenerated by Fhircraft 0.3.3 on 2025-11-07 18:12:58.812998.
...
class OnconovaTNMLymphaticInvasionCategoryUsCore(CodeableConcept):
    """
...
class OnconovaTNMLymphaticInvasionCategoryReferenceRange(BackboneElement):
    """
...
class OnconovaTNMLymphaticInvasionCategoryComponentReferenceRange(BackboneElement):
    """
...
class OnconovaTNMLymphaticInvasionCategoryComponent(BackboneElement):
    """
    ...
    referenceRange: Optional[List[OnconovaTNMLymphaticInvasionCategoryComponentReferenceRange]] = Field(
...
class OnconovaTNMLymphaticInvasionCategory(FHIRBaseModel):
    """
...
This profile extends the base mCODE [TNMCategory profile](http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-tnm-category) to specify the new TNM category.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-tnm-lymphatic-invasion-category'], versionId="0.2.0"),
    )
    ...
    category: Optional[List[Annotated[Union[OnconovaTNMLymphaticInvasionCategoryUsCore, CodeableConcept], Field(union_mode='left_to_right')]]] = Field(
    ...
    referenceRange: Optional[List[OnconovaTNMLymphaticInvasionCategoryReferenceRange]] = Field(
        description="Not used in this profile",
        default=None,
    )
    ...
    component: Optional[List[OnconovaTNMLymphaticInvasionCategoryComponent]] = Field(
