# Code autogenerated by Fhircraft 0.3.1 on 2025-10-09 07:26:53.137989.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Element,Meta,Narrative,Resource,Extension,Identifier,Reference,CodeableConcept,Period,Timing,Quantity,Range,Ratio,SampledData,Annotation,BackboneElement
 
from fhircraft.fhir.resources.validators import validate_element_constraint,get_type_choice_value_by_base,validate_FHIR_element_pattern,validate_type_choice_element,validate_slicing_cardinalities,validate_contained_resource,validate_model_constraint
...
class SmokingStatus(BackboneElement):
    """
    Component results
    """
    ...
    code: CodeableConcept = Field(
        ...
        default_factory=lambda: CodeableConcept(coding=[{'system': 'http://loinc.org', 'code': '72166-2', 'display': 'Tobacco smoking status'}]),
    )
    ...
    def FHIR_code_pattern_constraint(cls, value):    
        return validate_FHIR_element_pattern(cls, value, 
            pattern=CodeableConcept(coding=[{'system': 'http://loinc.org', 'code': '72166-2', 'display': 'Tobacco smoking status'}]),
        )
...
class SmokingPackyears(BackboneElement):
    """
    Component results
    """
    extension: Optional[List[Extension]] = Field(
    ...
    code: CodeableConcept = Field(
        description="Type of component observation (code / type)",
        default_factory=lambda: CodeableConcept(coding=[{'system': 'http://loinc.org', 'code': '8664-5', 'display': 'Cigarettes smoked total (pack per year) - Reported'}]),
    )
    ...
    def FHIR_code_pattern_constraint(cls, value):    
        return validate_FHIR_element_pattern(cls, value, 
            pattern=CodeableConcept(coding=[{'system': 'http://loinc.org', 'code': '8664-5', 'display': 'Cigarettes smoked total (pack per year) - Reported'}]),
        )
...
class SmokingQuited(BackboneElement):
    """
    Component results
    """
    extension: Optional[List[Extension]] = Field(
    ...
    code: CodeableConcept = Field(
        description="Type of component observation (code / type)",
        default_factory=lambda: CodeableConcept(coding=[{'system': 'http://loinc.org', 'code': '107339-4', 'display': 'Temporary smoking cessation [Time]'}]),
    )
    valueQuantity: Optional[Quantity] = Field(
        description="Actual component result",
        default=None,
    ...
    def FHIR_code_pattern_constraint(cls, value):    
        return validate_FHIR_element_pattern(cls, value, 
            pattern=CodeableConcept(coding=[{'system': 'http://loinc.org', 'code': '107339-4', 'display': 'Temporary smoking cessation [Time]'}]),
        )
...
class AlcoholConsumption(BackboneElement):
    """
    Component results
    """
    extension: Optional[List[Extension]] = Field(
    ...
    code: CodeableConcept = Field(
        description="Type of component observation (code / type)",
        default_factory=lambda: CodeableConcept(coding=[{'system': 'http://loinc.org', 'code': '1106630-7', 'display': 'Alcohol use pattern'}]),
    )
    valueCodeableConcept: Optional[CodeableConcept] = Field(
        description="Actual component result",
        default=None,
    ...
    def FHIR_code_pattern_constraint(cls, value):    
        return validate_FHIR_element_pattern(cls, value, 
            pattern=CodeableConcept(coding=[{'system': 'http://loinc.org', 'code': '1106630-7', 'display': 'Alcohol use pattern'}]),
        )
...
class NightSleep(BackboneElement):
    """
    Component results
    """
    extension: Optional[List[Extension]] = Field(
    ...
    code: CodeableConcept = Field(
        description="Type of component observation (code / type)",
        default_factory=lambda: CodeableConcept(coding=[{'system': 'http://loinc.org', 'code': '93832-4', 'display': 'Sleep duration'}]),
    )
    valueQuantity: Optional[Quantity] = Field(
        description="Actual component result",
        default=None,
    ...
    def FHIR_code_pattern_constraint(cls, value):    
        return validate_FHIR_element_pattern(cls, value, 
            pattern=CodeableConcept(coding=[{'system': 'http://loinc.org', 'code': '93832-4', 'display': 'Sleep duration'}]),
        )
...
class RecreationalDrug(BackboneElement):
    """
    Component results
    """
    extension: Optional[List[Extension]] = Field(
    ...
    code: CodeableConcept = Field(
        description="Type of component observation (code / type)",
        default_factory=lambda: CodeableConcept(coding=[{'system': 'http://ncicb.nci.nih.gov/xml/owl/EVS/Thesaurus.owl', 'code': 'C84368', 'display': 'Recreational Drug'}]),
    )
    valueCodeableConcept: Optional[CodeableConcept] = Field(
        description="Actual component result",
        default=None,
    ...
    def FHIR_code_pattern_constraint(cls, value):    
        return validate_FHIR_element_pattern(cls, value, 
            pattern=CodeableConcept(coding=[{'system': 'http://ncicb.nci.nih.gov/xml/owl/EVS/Thesaurus.owl', 'code': 'C84368', 'display': 'Recreational Drug'}]),
        )
...
class Exposures(BackboneElement):
    """
    Component results
    """
    extension: Optional[List[Extension]] = Field(
    ...
    code: CodeableConcept = Field(
        description="Type of component observation (code / type)",
        default_factory=lambda: CodeableConcept(coding=[{'system': 'http://ncicb.nci.nih.gov/xml/owl/EVS/Thesaurus.owl', 'code': 'C16552', 'display': 'Environmental Exposure'}]),
    )
    valueCodeableConcept: Optional[CodeableConcept] = Field(
        description="Actual component result",
        default=None,
    ...
    def FHIR_code_pattern_constraint(cls, value):    
        return validate_FHIR_element_pattern(cls, value, 
            pattern=CodeableConcept(coding=[{'system': 'http://ncicb.nci.nih.gov/xml/owl/EVS/Thesaurus.owl', 'code': 'C16552', 'display': 'Environmental Exposure'}]),
        )
...
It directly profiles the base FHIR `Observation` resource as this resource is not represented in mCODE, to add relevant observation components for the different lifestyle characteristics. 
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='0.1.0', profile=['http://luisfabib.github.io/onconova/StructureDefinition/onconova-lifestyle']),
    )
    ...
    category: Optional[List[Annotated[Union[UsCore, CodeableConcept], Field(union_mode='left_to_right')]]] = Field(
        description="(USCDI) Classification of  type of observation",
        default=None,
    )
    code: CodeableConcept = Field(
        description="(USCDI) Type of observation (code / type)",
        default_factory=lambda: CodeableConcept(coding=[{'system': 'http://loinc.org', 'code': 'LA32823-9', 'display': 'Lifestyle'}]),
    )
    ...
    component: Optional[List[Annotated[Union[SmokingStatus, SmokingPackyears, SmokingQuited, AlcoholConsumption, NightSleep, RecreationalDrug, Exposures, BackboneElement], Field(union_mode='left_to_right')]]] = Field(
