# Code autogenerated by Fhircraft 0.4.1 on 2025-12-04 08:14:49.873578.
...
class OnconovaLymphomaStageUsCore(CodeableConcept, FHIRSliceModel):
    """
...
class OnconovaLymphomaStageReferenceRange(BackboneElement):
    """
...
class OnconovaLymphomaStageStageModifierComponentReferenceRange(BackboneElement):
    """
...
class OnconovaLymphomaStageStageModifier(BackboneElement, FHIRSliceModel):
    """
    Component results
    """
    ...
    referenceRange: Optional[
        List[OnconovaLymphomaStageStageModifierComponentReferenceRange]
    ] = Field(
...
class OnconovaLymphomaStageClinOrPathModifier(BackboneElement, FHIRSliceModel):
    """
    Component results
    """
...
class OnconovaLymphomaStageBulkyModifier(BackboneElement, FHIRSliceModel):
    """
    Component results
    """
...
class OnconovaLymphomaStage(DomainResource):
    """
    ...
    **Conformance:**
    ...
    category: Optional[
        List[
            Annotated[
                Union[OnconovaLymphomaStageUsCore, CodeableConcept],
    ...
    referenceRange: Optional[List[OnconovaLymphomaStageReferenceRange]] = Field(
        description="Not used in this profile",
        default=None,
    )
    ...
    component: Optional[
        List[
            Annotated[
                Union[
                    OnconovaLymphomaStageStageModifier,
                    OnconovaLymphomaStageClinOrPathModifier,
                    OnconovaLymphomaStageBulkyModifier,
                    BackboneElement,
                ],
                Field(union_mode="left_to_right"),
            ]
