# Code autogenerated by Fhircraft 0.4.1 on 2025-12-04 08:14:54.972233.
...
class OnconovaTNMVenousInvasionCategoryUsCore(CodeableConcept, FHIRSliceModel):
    """
...
class OnconovaTNMVenousInvasionCategoryComponent(BackboneElement):
    ...
    referenceRange: Optional[
        List[OnconovaTNMVenousInvasionCategoryComponentReferenceRange]
    ] = Field(
...
class OnconovaTNMVenousInvasionCategory(DomainResource):
    """
    ...
    **Conformance:**
    ...
    category: Optional[
        List[
            Annotated[
                Union[OnconovaTNMVenousInvasionCategoryUsCore, CodeableConcept],
    ...
    referenceRange: Optional[List[OnconovaTNMVenousInvasionCategoryReferenceRange]] = (
        Field(
            description="Not used in this profile",
            default=None,
        )
