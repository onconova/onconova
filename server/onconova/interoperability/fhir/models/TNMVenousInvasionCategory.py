# Code autogenerated by Fhircraft 0.3.4 on 2025-11-11 15:54:05.651613.
...
class OnconovaTNMVenousInvasionCategoryUsCore(CodeableConcept):
    """
...
class OnconovaTNMVenousInvasionCategoryReferenceRange(BackboneElement):
    """
...
class OnconovaTNMVenousInvasionCategoryComponentReferenceRange(BackboneElement):
    """
...
class OnconovaTNMVenousInvasionCategoryComponent(BackboneElement):
    """
    ...
    referenceRange: Optional[List[OnconovaTNMVenousInvasionCategoryComponentReferenceRange]] = Field(
...
class OnconovaTNMVenousInvasionCategory(FHIRBaseModel):
    """
...
This profile extends the base mCODE [TNMCategory profile](http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-tnm-category) to specify the new TNM category.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-venous-invasion-category'], versionId="0.2.0"),
    )
    ...
    category: Optional[List[Annotated[Union[OnconovaTNMVenousInvasionCategoryUsCore, CodeableConcept], Field(union_mode='left_to_right')]]] = Field(
    ...
    referenceRange: Optional[List[OnconovaTNMVenousInvasionCategoryReferenceRange]] = Field(
        description="Not used in this profile",
        default=None,
    )
    ...
    component: Optional[List[OnconovaTNMVenousInvasionCategoryComponent]] = Field(
