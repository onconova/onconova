# Code autogenerated by Fhircraft 0.5.0 on 2026-02-23 17:27:03.762690.
...
class OnconovaTNMVenousInvasionCategory(TNMCategory):
    """
...
Observation resources representing a TNM staging venous invasion parameter in the scope of Onconova SHALL conform to this profile. Any resource intended to conform to this profile SHOULD populate `meta.profile` accordingly. 
    ...
    _canonical_url = "http://onconova.github.io/fhir/StructureDefinition/onconova-tnm-venous-invasion-category"

    meta: Optional[Meta] = Field(
        title="Meta",
        description="Metadata about the resource.",
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-tnm-venous-invasion-category']),
    )
    status: Optional[Code] = Field(
        description="Not used in this profile",
        default=None,
    ...
    code: Optional[CodeableConcept] = Field(
        description="(USCDI) Type of observation (code / type)",
        default_factory=lambda: CodeableConcept(coding=[Coding(code="369732007", display="Venous (large vessel) tumor invasion finding (finding)", system="http://snomed.info/sct")]),
    )
    ...
    def FHIR_code_pattern_constraint(cls, value):    
        return validate_FHIR_element_pattern(cls, value, 
            pattern=CodeableConcept(coding=[Coding(code="369732007", display="Venous (large vessel) tumor invasion finding (finding)", system="http://snomed.info/sct")]),
        )
