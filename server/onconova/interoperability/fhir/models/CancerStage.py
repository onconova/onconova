# Code autogenerated by Fhircraft 0.5.0 on 2026-02-23 17:27:16.370205.
...
Observation resources representing a cancer staging in the scope of Onconova SHALL conform to this profile. Any resource intended to conform to this profile SHOULD populate `meta.profile` accordingly. 
    ...
    meta: Optional[Meta] = Field(
        title="Meta",
        description="Metadata about the resource.",
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-cancer-stage']),
    )
    status: Optional[Code] = Field(
        description="Not used in this profile",
        default=None,
    ...
    component: Optional[List[Annotated[Union[OnconovaCancerStageUlceration, BackboneElement], Field(union_mode='left_to_right')]]] = Field(
        description="Component results",
        default=None,
    )
