# Code autogenerated by Fhircraft 0.3.3 on 2025-11-07 18:12:57.200040.
...
from fhircraft.fhir.resources.datatypes.R4.resources.observation import (
...
class GenePanel(FHIRSliceModel):
    ...
    url: Literal[
        "http://onconova.github.io/fhir/StructureDefinition/onconova-ext-gene-panel"
    ] = Field(
        description="identifies the meaning of the extension",
...
class HgvsVersion(FHIRSliceModel):
    ...
    url: Literal[
        "http://onconova.github.io/fhir/StructureDefinition/onconova-ext-hgvs-version"
    ] = Field(
        description="identifies the meaning of the extension",
