# Code autogenerated by Fhircraft 0.3.3 on 2025-11-07 18:12:47.663505.
...
class OnconovaAneuploidScoreLabCategory(CodeableConcept):
    """
...
class OnconovaAneuploidScoreConclusionString(BackboneElement):
    """
    Clinical Conclusion
    """
    extension: Optional[List[Extension]] = Field(
    ...
    referenceRange: Optional[List[OnconovaAneuploidScoreConclusionStringComponentReferenceRange]] = Field(
...
This profile extends the GenomicsReporting IG [GenomicsBase profile](http://hl7.org/fhir/uv/genomics-reporting/StructureDefinition/genomics-base) to include specific constraints and extensions relevant to Onconova.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-aneuploid-score'], versionId="0.2.0"),
    )
    ...
    category: Optional[List[Annotated[Union[OnconovaAneuploidScoreLabCategory, CodeableConcept], Field(union_mode='left_to_right')]]] = Field(
    ...
    component: Optional[List[Annotated[Union[OnconovaAneuploidScoreConclusionString, BackboneElement], Field(union_mode='left_to_right')]]] = Field(
