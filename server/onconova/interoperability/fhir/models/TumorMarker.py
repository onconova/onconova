# Code autogenerated by Fhircraft 0.3.4 on 2025-11-11 15:54:10.571487.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Element,Meta,Narrative,Resource,Extension,CodeableConcept,Reference,Identifier,Quantity,Ratio,Annotation,BackboneElement,Range,SampledData,Period
...
class TumorMarkerAnalyte(FHIRSliceModel):
    ...
    url: Literal['http://onconova.github.io/fhir/StructureDefinition/onconova-ext-tumor-marker-analyte'] = Field(
        description="identifies the meaning of the extension",
...
class OnconovaTumorMarkerUsCore(CodeableConcept):
    """
...
class OnconovaTumorMarker(FHIRBaseModel):
    """
...
If relied on the same use context as mCODE, namely for substances found in tissue or blood or other body fluids that may be a sign of cancer or certain benign (non-cancer) conditions measured at the levels of the protein and substance post-RNA protein synthesis (not at genomic level).
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-tumor-marker'], versionId="0.2.0"),
    )
    ...
    category: Optional[List[Annotated[Union[OnconovaTumorMarkerUsCore, CodeableConcept], Field(union_mode='left_to_right')]]] = Field(
