# Code autogenerated by Fhircraft 0.3.1 on 2025-10-09 07:26:42.785296.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Element,Meta,Narrative,Resource,Extension,CodeableConcept,Reference,Identifier,Period,Quantity,Ratio,Annotation,BackboneElement,Range,SampledData
...
class TumorMarkerAnalyte(FHIRSliceModel):
    ...
    url: Literal['http://luisfabib.github.io/onconova/StructureDefinition/onconova-ext-tumor-marker-analyte'] = Field(
        description="identifies the meaning of the extension",
        default="http://luisfabib.github.io/onconova/StructureDefinition/onconova-ext-tumor-marker-analyte",
    )
    valueCodeableConcept: Optional[CodeableConcept] = Field(
        description="Value of extension",
        default=None,
...
class TumorMarkerAnalyteReferenceRange(BackboneElement):
    """
...
class TumorMarkerAnalyteComponent(BackboneElement):
    """
...
class TumorMarkerAnalyte(FHIRBaseModel):
    """
...
If relied on the same use context as mCODE, namely for substances found in tissue or blood or other body fluids that may be a sign of cancer or certain benign (non-cancer) conditions measured at the levels of the protein and substance post-RNA protein synthesis (not at genomic level).
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='0.1.0', profile=['http://luisfabib.github.io/onconova/StructureDefinition/onconova-tumor-marker']),
    )
    ...
    extension: Optional[List[Annotated[Union[RelatedCondition, "TumorMarkerAnalyte", Extension], Field(union_mode='left_to_right')]]] = Field(
        description="Extension",
        default=None,
    )
    ...
    referenceRange: Optional[List[TumorMarkerAnalyteReferenceRange]] = Field(
    ...
    component: Optional[List[TumorMarkerAnalyteComponent]] = Field(
