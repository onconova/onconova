# Code autogenerated by Fhircraft 0.3.4 on 2025-11-11 15:54:04.042454.
...
from fhircraft.fhir.resources.datatypes.primitives import String,Uri,Code,Decimal,Integer,DateTime,Instant,Boolean,Time
...
class RiskAssessmentScore(FHIRSliceModel):
    """
    ...
    url: Literal['http://onconova.github.io/fhir/StructureDefinition/onconova-ext-risk-assessment-score'] = Field(
...
class OnconovaCancerRiskAssessmentUsCore(CodeableConcept):
    """
...
class OnconovaCancerRiskAssessmentReferenceRange(BackboneElement):
    """
...
class OnconovaCancerRiskAssessmentComponentReferenceRange(BackboneElement):
    """
...
class OnconovaCancerRiskAssessmentComponent(BackboneElement):
    """
    Not used in this profile
    """
    ...
    referenceRange: Optional[List[OnconovaCancerRiskAssessmentComponentReferenceRange]] = Field(
...
It constraints the mCODE [CancerRiskAssessment profile](http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-cancer-risk-assessment) and expands the valuesets for cancer risk assessment methods and values.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-cancer-risk-assessment'], versionId="0.2.0"),
    )
    ...
    category: Optional[List[Annotated[Union[OnconovaCancerRiskAssessmentUsCore, CodeableConcept], Field(union_mode='left_to_right')]]] = Field(
    ...
    referenceRange: Optional[List[OnconovaCancerRiskAssessmentReferenceRange]] = Field(
        description="Not used in this profile",
        default=None,
    )
    ...
    component: Optional[List[OnconovaCancerRiskAssessmentComponent]] = Field(
        description="Not used in this profile",
        default=None,
    )
