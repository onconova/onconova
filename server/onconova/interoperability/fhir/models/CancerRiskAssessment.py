# Code autogenerated by Fhircraft 0.3.1 on 2025-10-09 07:26:42.072750.
...
class RiskAssessmentScore(FHIRSliceModel):
    ...
    url: Literal['http://luisfabib.github.io/onconova/StructureDefinition/onconova-ext-risk-assessment-score'] = Field(
        description="identifies the meaning of the extension",
        default="http://luisfabib.github.io/onconova/StructureDefinition/onconova-ext-risk-assessment-score",
    )
...
class RiskAssessmentScoreReferenceRange(BackboneElement):
    """
...
class RiskAssessmentScoreComponent(BackboneElement):
    """
...
class RiskAssessmentScore(FHIRBaseModel):
    """
...
It constraints the mCODE [CancerRiskAssessment profile](http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-cancer-risk-assessment) and expands the valuesets for cancer risk assessment methods and values.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='0.1.0', profile=['http://luisfabib.github.io/onconova/StructureDefinition/onconova-cancer-risk-assessment']),
    )
    ...
    referenceRange: Optional[List[RiskAssessmentScoreReferenceRange]] = Field(
        description="Not used in this profile",
        default=None,
    )
    ...
    component: Optional[List[RiskAssessmentScoreComponent]] = Field(
