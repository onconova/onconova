...
class OnconovaCancerRiskAssessmentComponent(BackboneElement):
    ...
    referenceRange: Optional[
        List[OnconovaCancerRiskAssessmentComponentReferenceRange]
    ] = Field(
...
class OnconovaCancerRiskAssessment(FHIRBaseModel):
    ...
    extension: Optional[
        List[
            Annotated[
                Union[RiskAssessmentScore, Extension], Field(union_mode="left_to_right")
            ]
        ]
    ] = Field(
        description="Extension",
    ...
    category: Optional[
        List[
            Annotated[
                Union[OnconovaCancerRiskAssessmentUsCore, CodeableConcept],
