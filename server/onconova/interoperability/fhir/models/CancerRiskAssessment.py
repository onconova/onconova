# Code autogenerated by Fhircraft 0.5.0 on 2026-04-11 19:03:18.108030.
...
from fhircraft.fhir.resources.datatypes.R4.primitive import Boolean, Code, DateTime, Decimal, Id, Instant, Integer, String, Time, Uri
from fhircraft.fhir.resources.datatypes.R4.complex import CodeableConcept, Extension, Period, Quantity, Range, Ratio, Reference, SampledData, Timing
...
class OnconovaCancerRiskAssessmentRiskAssessmentScore(RiskAssessmentScore, FHIRSliceModel):
    """
...
class OnconovaCancerRiskAssessment(CancerRiskAssessment):
    ...
    extension: Optional[list[Union[OnconovaCancerRiskAssessmentRiskAssessmentScore, Extension]]] = Field(
        description="Additional content defined by implementations",
        default=None,
    )
