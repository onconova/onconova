# Code autogenerated by Fhircraft 0.3.3 on 2025-11-07 18:13:08.859563.
...
from fhircraft.fhir.resources.datatypes.primitives import String,Uri,Code,DateTime,Instant,Integer,Boolean,Time
...
class OnconovaKarnofskyPerformanceStatusUsCore(CodeableConcept):
    """
...
class OnconovaKarnofskyPerformanceStatusReferenceRange(BackboneElement):
    """
...
class OnconovaKarnofskyPerformanceStatusComponentReferenceRange(BackboneElement):
    """
...
class OnconovaKarnofskyPerformanceStatusComponent(BackboneElement):
    """
    Not used in this profile
    """
    ...
    referenceRange: Optional[List[OnconovaKarnofskyPerformanceStatusComponentReferenceRange]] = Field(
...
class OnconovaKarnofskyPerformanceStatus(FHIRBaseModel):
    """
...
Adds minimal constraints to the mCODE [KarnofskyPerformanceStatus profile](http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-karnofsky-performance-status) to account for Onconova specifics.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-Karnofsky-performance-status'], versionId="0.2.0"),
    )
    ...
    category: Optional[List[Annotated[Union[OnconovaKarnofskyPerformanceStatusUsCore, CodeableConcept], Field(union_mode='left_to_right')]]] = Field(
    ...
    referenceRange: Optional[List[OnconovaKarnofskyPerformanceStatusReferenceRange]] = Field(
        description="Not used in this profile",
        default=None,
    )
    ...
    component: Optional[List[OnconovaKarnofskyPerformanceStatusComponent]] = Field(
        description="Not used in this profile",
        default=None,
    )
