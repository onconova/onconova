# Code autogenerated by Fhircraft 0.4.1 on 2025-12-04 08:14:47.227994.
...
class OnconovaKarnofskyPerformanceStatusUsCore(CodeableConcept, FHIRSliceModel):
    """
...
class OnconovaKarnofskyPerformanceStatusComponent(BackboneElement):
    ...
    referenceRange: Optional[
        List[OnconovaKarnofskyPerformanceStatusComponentReferenceRange]
    ] = Field(
...
class OnconovaKarnofskyPerformanceStatus(DomainResource):
    """
    ...
    **Conformance:**
    ...
    category: Optional[
        List[
            Annotated[
                Union[OnconovaKarnofskyPerformanceStatusUsCore, CodeableConcept],
    ...
    referenceRange: Optional[List[OnconovaKarnofskyPerformanceStatusReferenceRange]] = (
        Field(
            description="Not used in this profile",
            default=None,
        )
