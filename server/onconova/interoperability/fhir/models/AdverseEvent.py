...
class CTCGrade(FHIRSliceModel):
    ...
    url: Literal[
        "http://onconova.github.io/fhir/StructureDefinition/onconova-ext-ctc-grade"
    ] = Field(
...
class AdverseEventMitigation(FHIRSliceModel):
    ...
    extension: Optional[
        List[
            Annotated[
                Union[Category, Adjustment, Drug, Procedure, Management, Extension],
...
class AdverseEventMitigation(FHIRBaseModel):
    ...
    extension: Optional[
        List[
            Annotated[
                Union[CTCGrade, "AdverseEventMitigation", Extension],
                Field(union_mode="left_to_right"),
            ]
        ]
    ] = Field(
