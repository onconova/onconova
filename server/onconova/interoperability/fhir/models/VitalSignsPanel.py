# Code autogenerated by Fhircraft 0.5.0 on 2026-04-11 19:03:13.845519.
...
from fhircraft.fhir.resources.datatypes.R4.complex import CodeableConcept, Coding, Period, Quantity, Range, Ratio, Reference, SampledData
...
class ObservationVitalsigns(Observation):
    ...
    category: Optional[list[Union[ObservationVitalsignsVSCat, CodeableConcept]]] = Field(
...
class ObservationVitalspanelCode(CodeableConcept):
    ...
    coding: Optional[list[Union[ObservationVitalspanelVitalsPanelCode, Coding]]] = Field(
...
class OnconovaVitalSignsPanel(ObservationVitalspanel):
    ...
    hasMember: Optional[list[Union[OnconovaVitalSignsPanelBodyTemperature, OnconovaVitalSignsPanelBodyHeight, OnconovaVitalSignsPanelBodyWeight, OnconovaVitalSignsPanelBmi, OnconovaVitalSignsPanelBloodPressure, Reference]]] = Field(
        description="Used when reporting vital signs panel components",
        default=None,
    )
    component: Optional[List[ObservationVitalsignsComponent]] = Field(
