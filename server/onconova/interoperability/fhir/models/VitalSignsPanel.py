# Code autogenerated by Fhircraft 0.4.1 on 2025-12-04 08:14:21.953643.
...
class OnconovaVitalSignsPanelVSCatCategoryCoding(Coding):
    """
...
class OnconovaVitalSignsPanelVSCat(CodeableConcept, FHIRSliceModel):
    """
    ...
    coding: Optional[List[OnconovaVitalSignsPanelVSCatCategoryCoding]] = Field(
...
class OnconovaVitalSignsPanelCode(CodeableConcept):
    """
    Vital Signs Panel.
    """
...
class OnconovaVitalSignsPanelReferenceRange(BackboneElement):
    """
...
class OnconovaVitalSignsPanelComponent(BackboneElement):
    """
    Not used in this profile
    """
    ...
    referenceRange: Optional[List[OnconovaVitalSignsPanelComponentReferenceRange]] = (
        Field(
...
class OnconovaVitalSignsPanel(DomainResource):
    """
    ...
    **Conformance:**
    ...
    category: Optional[
        List[
            Annotated[
                Union[OnconovaVitalSignsPanelVSCat, CodeableConcept],
    ...
    code: OnconovaVitalSignsPanelCode = Field(
        description="Vital Signs Panel",
        default_factory=lambda: OnconovaVitalSignsPanelCode(
    ...
    referenceRange: Optional[List[OnconovaVitalSignsPanelReferenceRange]] = Field(
        description="Not used in this profile",
        default=None,
    )
    hasMember: Optional[
    ...
    component: Optional[List[OnconovaVitalSignsPanelComponent]] = Field(
        description="Not used in this profile",
        default=None,
    )
    ...
    @classmethod
    def FHIR_vs_3_constraint_validator(cls, value):
        return validate_element_constraint(
            cls,
            value,
