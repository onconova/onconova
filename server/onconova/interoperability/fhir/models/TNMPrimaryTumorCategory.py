# Code autogenerated by Fhircraft 0.3.4 on 2025-11-11 15:53:53.023610.
...
class OnconovaTNMPrimaryTumorCategoryUsCore(CodeableConcept):
    """
...
class OnconovaTNMPrimaryTumorCategoryReferenceRange(BackboneElement):
    """
...
class OnconovaTNMPrimaryTumorCategoryComponentReferenceRange(BackboneElement):
    """
...
class OnconovaTNMPrimaryTumorCategoryComponent(BackboneElement):
    """
    ...
    referenceRange: Optional[List[OnconovaTNMPrimaryTumorCategoryComponentReferenceRange]] = Field(
...
class OnconovaTNMPrimaryTumorCategory(FHIRBaseModel):
    """
...
This profile extends the base mCODE [TNMPrimaryTumorCategory profile](http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-tnm-primary-tumor-category) to include specific constraints and extensions relevant to Onconova.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-tnm-primary-tumor-category'], versionId="0.2.0"),
    )
    ...
    category: Optional[List[Annotated[Union[OnconovaTNMPrimaryTumorCategoryUsCore, CodeableConcept], Field(union_mode='left_to_right')]]] = Field(
    ...
    referenceRange: Optional[List[OnconovaTNMPrimaryTumorCategoryReferenceRange]] = Field(
        description="Not used in this profile",
        default=None,
    )
    ...
    component: Optional[List[OnconovaTNMPrimaryTumorCategoryComponent]] = Field(
