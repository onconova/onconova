# Code autogenerated by Fhircraft 0.4.1 on 2025-12-04 08:14:30.458532.
...
class OnconovaTNMPrimaryTumorCategoryUsCore(CodeableConcept, FHIRSliceModel):
    """
...
class OnconovaTNMPrimaryTumorCategoryComponent(BackboneElement):
    ...
    referenceRange: Optional[
        List[OnconovaTNMPrimaryTumorCategoryComponentReferenceRange]
    ] = Field(
...
class OnconovaTNMPrimaryTumorCategory(DomainResource):
    """
    ...
    **Conformance:**
    ...
    category: Optional[
        List[
            Annotated[
                Union[OnconovaTNMPrimaryTumorCategoryUsCore, CodeableConcept],
    ...
    referenceRange: Optional[List[OnconovaTNMPrimaryTumorCategoryReferenceRange]] = (
        Field(
            description="Not used in this profile",
            default=None,
        )
