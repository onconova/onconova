# Code autogenerated by Fhircraft 0.5.0 on 2026-02-23 17:26:47.603381.
...
class TNMPrimaryTumorCategory(TNMCategory):
    ...
    meta: Optional[Meta] = Field(
        title="Meta",
        description="Metadata about the resource.",
        default_factory=lambda: Meta(profile=['http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-tnm-primary-tumor-category']),
    )
...
Observation resources representing a TNM staging primary tumor parameter in the scope of Onconova SHALL conform to this profile. Any resource intended to conform to this profile SHOULD populate `meta.profile` accordingly. 
    ...
    meta: Optional[Meta] = Field(
        title="Meta",
        description="Metadata about the resource.",
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-tnm-primary-tumor-category']),
    )
    status: Optional[Code] = Field(
        description="Not used in this profile",
        default=None,
