# Code autogenerated by Fhircraft 0.4.1 on 2025-12-04 08:15:08.259239.
...
class OnconovaLossOfHeterozygosityLabCategory(CodeableConcept, FHIRSliceModel):
    """
...
class OnconovaLossOfHeterozygosityConclusionStringComponentReferenceRange(
    BackboneElement
):
    """
...
class OnconovaLossOfHeterozygosityConclusionString(BackboneElement, FHIRSliceModel):
    """
    Clinical Conclusion
    """
    ...
    referenceRange: Optional[
        List[OnconovaLossOfHeterozygosityConclusionStringComponentReferenceRange]
    ] = Field(
...
class OnconovaLossOfHeterozygosity(DomainResource):
    """
    ...
    **Conformance:**
    ...
    category: Optional[
        List[
            Annotated[
                Union[OnconovaLossOfHeterozygosityLabCategory, CodeableConcept],
                Field(union_mode="left_to_right"),
            ]
        ]
    ] = Field(
    ...
    component: Optional[
        List[
            Annotated[
                Union[OnconovaLossOfHeterozygosityConclusionString, BackboneElement],
                Field(union_mode="left_to_right"),
            ]
        ]
    ] = Field(
