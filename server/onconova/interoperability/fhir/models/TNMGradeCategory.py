# Code autogenerated by Fhircraft 0.4.1 on 2025-12-04 08:15:03.689682.
...
class OnconovaTNMGradeCategoryUsCore(CodeableConcept, FHIRSliceModel):
    """
...
class OnconovaTNMGradeCategoryComponent(BackboneElement):
    ...
    referenceRange: Optional[List[OnconovaTNMGradeCategoryComponentReferenceRange]] = (
        Field(
...
class OnconovaTNMGradeCategory(DomainResource):
    """
    ...
    **Conformance:**
    ...
    category: Optional[
        List[
            Annotated[
                Union[OnconovaTNMGradeCategoryUsCore, CodeableConcept],
