# Code autogenerated by Fhircraft 0.3.4 on 2025-11-11 15:54:06.981133.
...
class OnconovaTNMGradeCategoryUsCore(CodeableConcept):
    """
...
class OnconovaTNMGradeCategoryReferenceRange(BackboneElement):
    """
...
class OnconovaTNMGradeCategoryComponentReferenceRange(BackboneElement):
    """
...
class OnconovaTNMGradeCategoryComponent(BackboneElement):
    """
    ...
    referenceRange: Optional[List[OnconovaTNMGradeCategoryComponentReferenceRange]] = Field(
...
class OnconovaTNMGradeCategory(FHIRBaseModel):
    """
...
This profile extends the base mCODE [TNMCategory profile](http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-tnm-category) to specify the new TNM category.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-tnm-grade-category'], versionId="0.2.0"),
    )
    ...
    category: Optional[List[Annotated[Union[OnconovaTNMGradeCategoryUsCore, CodeableConcept], Field(union_mode='left_to_right')]]] = Field(
    ...
    referenceRange: Optional[List[OnconovaTNMGradeCategoryReferenceRange]] = Field(
        description="Not used in this profile",
        default=None,
    )
    ...
    component: Optional[List[OnconovaTNMGradeCategoryComponent]] = Field(
