# Code autogenerated by Fhircraft 0.5.0 on 2026-02-23 17:27:21.344007.
...
class OnconovaTNMGradeCategory(TNMCategory):
    """
...
Observation resources representing a TNM staging grade category parameter in the scope of Onconova SHALL conform to this profile. Any resource intended to conform to this profile SHOULD populate `meta.profile` accordingly. 
    ...
    _canonical_url = "http://onconova.github.io/fhir/StructureDefinition/onconova-tnm-grade-category"

    meta: Optional[Meta] = Field(
        title="Meta",
        description="Metadata about the resource.",
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-tnm-grade-category']),
    )
    status: Optional[Code] = Field(
        description="Not used in this profile",
        default=None,
