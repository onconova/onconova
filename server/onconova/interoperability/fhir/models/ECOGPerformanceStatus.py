# Code autogenerated by Fhircraft 0.4.1 on 2025-12-04 08:15:11.937956.
...
class OnconovaECOGPerformanceStatusUsCore(CodeableConcept, FHIRSliceModel):
    """
...
class OnconovaECOGPerformanceStatusComponent(BackboneElement):
    ...
    referenceRange: Optional[
        List[OnconovaECOGPerformanceStatusComponentReferenceRange]
    ] = Field(
...
class OnconovaECOGPerformanceStatus(DomainResource):
    ...
    **Conformance:**
    ...
    category: Optional[
        List[
            Annotated[
                Union[OnconovaECOGPerformanceStatusUsCore, CodeableConcept],
    ...
    code: CodeableConcept = Field(
        ...
        default_factory=lambda: CodeableConcept(
            coding=[Coding(code="89247-1", system="http://loinc.org")]
        ),
    )
