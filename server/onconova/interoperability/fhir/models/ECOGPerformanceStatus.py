# Code autogenerated by Fhircraft 0.3.4 on 2025-11-11 15:54:11.845048.
...
class OnconovaECOGPerformanceStatusUsCore(CodeableConcept):
    """
...
class OnconovaECOGPerformanceStatusReferenceRange(BackboneElement):
    """
...
class OnconovaECOGPerformanceStatusComponentReferenceRange(BackboneElement):
    """
...
class OnconovaECOGPerformanceStatusComponent(BackboneElement):
    """
    Not used in this profile
    """
    ...
    referenceRange: Optional[List[OnconovaECOGPerformanceStatusComponentReferenceRange]] = Field(
...
Adds minimal constraints to the mCODE [`ECOGPerformanceStatus` profile](http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-ecog-performance-status) to account for Onconova specifics.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-ecog-performance-status'], versionId="0.2.0"),
    )
    ...
    category: Optional[List[Annotated[Union[OnconovaECOGPerformanceStatusUsCore, CodeableConcept], Field(union_mode='left_to_right')]]] = Field(
    ...
    referenceRange: Optional[List[OnconovaECOGPerformanceStatusReferenceRange]] = Field(
        description="Not used in this profile",
        default=None,
    )
    ...
    component: Optional[List[OnconovaECOGPerformanceStatusComponent]] = Field(
        description="Not used in this profile",
        default=None,
    )
