# Code autogenerated by Fhircraft 0.5.0 on 2026-02-23 17:27:27.782739.
...
class ECOGPerformanceStatus(USCoreObservationClinicalResultProfile):
    """
    ...
    _canonical_url = "http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-ecog-performance-status"

    meta: Optional[Meta] = Field(
        title="Meta",
        description="Metadata about the resource.",
        default_factory=lambda: Meta(profile=['http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-ecog-performance-status']),
    )
    ...
    code: Optional[CodeableConcept] = Field(
        description="(USCDI) Clinical Test or Procedure Name",
        default_factory=lambda: CodeableConcept(coding=[Coding(code="89247-1", system="http://loinc.org")]),
    )
    ...
    def FHIR_code_pattern_constraint(cls, value):    
        return validate_FHIR_element_pattern(cls, value, 
            pattern=CodeableConcept(coding=[Coding(code="89247-1", system="http://loinc.org")]),
        )
...
class OnconovaECOGPerformanceStatus(ECOGPerformanceStatus):
    """
...
Observation resources representing an ECOG performance status score in the scope of Onconova SHALL conform to this profile. Any resource intended to conform to this profile SHOULD populate `meta.profile` accordingly. 
    ...
    _canonical_url = "http://onconova.github.io/fhir/StructureDefinition/onconova-ecog-performance-status"

    meta: Optional[Meta] = Field(
        title="Meta",
        description="Metadata about the resource.",
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-ecog-performance-status']),
    )
    basedOn: Optional[List[Reference]] = Field(
        description="Not used in this profile",
        default=None,
