# Code autogenerated by Fhircraft 0.3.6 on 2025-11-22 15:19:50.333719.
...
from fhircraft.fhir.resources.validators import validate_element_constraint,get_type_choice_value_by_base,validate_type_choice_element,validate_slicing_cardinalities,validate_FHIR_element_pattern,validate_contained_resource,validate_model_constraint
...
Observation resources representing a TNM staging serum tumor marker level parameter in the scope of Onconova SHALL conform to this profile. Any resource intended to conform to this profile SHOULD populate `meta.profile` accordingly. 
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-tnm-serum-tumor-marker-level-category'], versionId="0.2.0"),
    )
