# Code autogenerated by Fhircraft 0.3.4 on 2025-11-11 15:54:04.830263.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Element,Meta,Narrative,Resource,Extension,Identifier,Reference,CodeableConcept,Coding,Annotation,BackboneElement,Quantity,Range,Ratio,SampledData,Period
...
class OnconovaTNMSerumTumorMarkerLevelCategoryUsCore(CodeableConcept):
    """
...
class OnconovaTNMSerumTumorMarkerLevelCategoryReferenceRange(BackboneElement):
    """
...
class OnconovaTNMSerumTumorMarkerLevelCategoryComponentReferenceRange(BackboneElement):
    """
...
class OnconovaTNMSerumTumorMarkerLevelCategoryComponent(BackboneElement):
    """
    ...
    referenceRange: Optional[List[OnconovaTNMSerumTumorMarkerLevelCategoryComponentReferenceRange]] = Field(
...
class OnconovaTNMSerumTumorMarkerLevelCategory(FHIRBaseModel):
    """
...
This profile extends the base mCODE [TNMCategory profile](http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-tnm-category) to specify the new TNM category.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-serous-tumor-marker-level-category'], versionId="0.2.0"),
    )
    ...
    category: Optional[List[Annotated[Union[OnconovaTNMSerumTumorMarkerLevelCategoryUsCore, CodeableConcept], Field(union_mode='left_to_right')]]] = Field(
    ...
    referenceRange: Optional[List[OnconovaTNMSerumTumorMarkerLevelCategoryReferenceRange]] = Field(
        description="Not used in this profile",
        default=None,
    )
    ...
    component: Optional[List[OnconovaTNMSerumTumorMarkerLevelCategoryComponent]] = Field(
