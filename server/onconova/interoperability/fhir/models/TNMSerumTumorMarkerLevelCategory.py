# Code autogenerated by Fhircraft 0.3.1 on 2025-10-09 07:26:53.584179.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Element,Meta,Narrative,Resource,Extension,Identifier,Reference,CodeableConcept,Period,Timing,Annotation,BackboneElement,Quantity,Range,Ratio,SampledData
...
This profile extends the base mCODE [TNMCategory profile](http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-tnm-category) to specify the new TNM category.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='0.1.0', profile=['http://luisfabib.github.io/onconova/StructureDefinition/onconova-serous-tumor-marker-level-category']),
    )
    ...
    code: CodeableConcept = Field(
        ...
        default_factory=lambda: CodeableConcept(coding=[{'system': 'http://snomed.info/sct', 'code': '396701002', 'display': 'Finding of serum tumor marker level (finding)'}]),
    )
    ...
    def FHIR_code_pattern_constraint(cls, value):    
        return validate_FHIR_element_pattern(cls, value, 
            pattern=CodeableConcept(coding=[{'system': 'http://snomed.info/sct', 'code': '396701002', 'display': 'Finding of serum tumor marker level (finding)'}]),
        )
