# Code autogenerated by Fhircraft 0.4.1 on 2025-12-04 08:14:56.271338.
...
class OnconovaTNMSerumTumorMarkerLevelCategoryUsCore(CodeableConcept, FHIRSliceModel):
    """
...
class OnconovaTNMSerumTumorMarkerLevelCategoryComponent(BackboneElement):
    ...
    referenceRange: Optional[
        List[OnconovaTNMSerumTumorMarkerLevelCategoryComponentReferenceRange]
    ] = Field(
...
class OnconovaTNMSerumTumorMarkerLevelCategory(DomainResource):
    """
    ...
    **Conformance:**
    ...
    category: Optional[
        List[
            Annotated[
                Union[OnconovaTNMSerumTumorMarkerLevelCategoryUsCore, CodeableConcept],
    ...
    referenceRange: Optional[
        List[OnconovaTNMSerumTumorMarkerLevelCategoryReferenceRange]
    ] = Field(
        description="Not used in this profile",
        default=None,
    )
    ...
    component: Optional[List[OnconovaTNMSerumTumorMarkerLevelCategoryComponent]] = (
        Field(
