# Code autogenerated by Fhircraft 0.5.0 on 2026-02-23 17:27:06.910212.
...
class OnconovaTNMSerumTumorMarkerLevelCategory(TNMCategory):
    """
...
Observation resources representing a TNM staging serum tumor marker level parameter in the scope of Onconova SHALL conform to this profile. Any resource intended to conform to this profile SHOULD populate `meta.profile` accordingly. 
    ...
    _canonical_url = "http://onconova.github.io/fhir/StructureDefinition/onconova-tnm-serum-tumor-marker-level-category"

    meta: Optional[Meta] = Field(
        title="Meta",
        description="Metadata about the resource.",
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-tnm-serum-tumor-marker-level-category']),
    )
    status: Optional[Code] = Field(
        description="Not used in this profile",
        default=None,
    ...
    code: Optional[CodeableConcept] = Field(
        description="(USCDI) Type of observation (code / type)",
        default_factory=lambda: CodeableConcept(coding=[Coding(code="396701002", display="Finding of serum tumor marker level (finding)", system="http://snomed.info/sct")]),
    )
    ...
    def FHIR_code_pattern_constraint(cls, value):    
        return validate_FHIR_element_pattern(cls, value, 
            pattern=CodeableConcept(coding=[Coding(code="396701002", display="Finding of serum tumor marker level (finding)", system="http://snomed.info/sct")]),
        )
