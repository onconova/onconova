# Code autogenerated by Fhircraft 0.3.3 on 2025-11-07 18:12:59.790377.
...
class OnconovaTNMPerineuralInvasionCategoryUsCore(CodeableConcept):
    """
...
class OnconovaTNMPerineuralInvasionCategoryReferenceRange(BackboneElement):
    """
...
class OnconovaTNMPerineuralInvasionCategoryComponentReferenceRange(BackboneElement):
    """
...
class OnconovaTNMPerineuralInvasionCategoryComponent(BackboneElement):
    """
    ...
    referenceRange: Optional[List[OnconovaTNMPerineuralInvasionCategoryComponentReferenceRange]] = Field(
...
class OnconovaTNMPerineuralInvasionCategory(FHIRBaseModel):
    """
...
This profile extends the base mCODE [TNMCategory profile](http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-tnm-category) to specify the new TNM category.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-tnm-perineural-invasion-category'], versionId="0.2.0"),
    )
    ...
    category: Optional[List[Annotated[Union[OnconovaTNMPerineuralInvasionCategoryUsCore, CodeableConcept], Field(union_mode='left_to_right')]]] = Field(
    ...
    referenceRange: Optional[List[OnconovaTNMPerineuralInvasionCategoryReferenceRange]] = Field(
        description="Not used in this profile",
        default=None,
    )
    ...
    component: Optional[List[OnconovaTNMPerineuralInvasionCategoryComponent]] = Field(
