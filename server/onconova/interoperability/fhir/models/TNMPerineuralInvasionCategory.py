# Code autogenerated by Fhircraft 0.4.1 on 2025-12-04 08:14:54.114318.
...
class OnconovaTNMPerineuralInvasionCategoryUsCore(CodeableConcept, FHIRSliceModel):
    """
...
class OnconovaTNMPerineuralInvasionCategoryComponent(BackboneElement):
    ...
    referenceRange: Optional[
        List[OnconovaTNMPerineuralInvasionCategoryComponentReferenceRange]
    ] = Field(
...
class OnconovaTNMPerineuralInvasionCategory(DomainResource):
    """
    ...
    **Conformance:**
    ...
    category: Optional[
        List[
            Annotated[
                Union[OnconovaTNMPerineuralInvasionCategoryUsCore, CodeableConcept],
    ...
    referenceRange: Optional[
        List[OnconovaTNMPerineuralInvasionCategoryReferenceRange]
    ] = Field(
        description="Not used in this profile",
        default=None,
    )
