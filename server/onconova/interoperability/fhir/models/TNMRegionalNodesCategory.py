# Code autogenerated by Fhircraft 0.4.1 on 2025-12-04 08:15:11.060103.
...
class OnconovaTNMRegionalNodesCategoryUsCore(CodeableConcept, FHIRSliceModel):
    """
...
class OnconovaTNMRegionalNodesCategoryComponent(BackboneElement):
    ...
    referenceRange: Optional[
        List[OnconovaTNMRegionalNodesCategoryComponentReferenceRange]
    ] = Field(
...
class OnconovaTNMRegionalNodesCategory(DomainResource):
    ...
    **Conformance:**
    ...
    category: Optional[
        List[
            Annotated[
                Union[OnconovaTNMRegionalNodesCategoryUsCore, CodeableConcept],
    ...
    referenceRange: Optional[List[OnconovaTNMRegionalNodesCategoryReferenceRange]] = (
        Field(
            description="Not used in this profile",
            default=None,
        )
