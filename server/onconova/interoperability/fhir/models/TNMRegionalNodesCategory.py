# Code autogenerated by Fhircraft 0.3.3 on 2025-11-07 18:13:09.794655.
...
class OnconovaTNMRegionalNodesCategoryUsCore(CodeableConcept):
    """
...
class OnconovaTNMRegionalNodesCategoryReferenceRange(BackboneElement):
    """
...
class OnconovaTNMRegionalNodesCategoryComponentReferenceRange(BackboneElement):
    """
...
class OnconovaTNMRegionalNodesCategoryComponent(BackboneElement):
    """
    ...
    referenceRange: Optional[List[OnconovaTNMRegionalNodesCategoryComponentReferenceRange]] = Field(
...
This profile extends the base mCODE [TNMRegionalNodesCategory profile](http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-tnm-regional-nodes-category) to include specific constraints and extensions relevant to Onconova.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-tnm-regional-nodes-category'], versionId="0.2.0"),
    )
    ...
    category: Optional[List[Annotated[Union[OnconovaTNMRegionalNodesCategoryUsCore, CodeableConcept], Field(union_mode='left_to_right')]]] = Field(
    ...
    referenceRange: Optional[List[OnconovaTNMRegionalNodesCategoryReferenceRange]] = Field(
        description="Not used in this profile",
        default=None,
    )
    ...
    component: Optional[List[OnconovaTNMRegionalNodesCategoryComponent]] = Field(
