...
class CancerMorphology(FHIRSliceModel):
    ...
    url: Literal[
        "http://onconova.github.io/fhir/StructureDefinition/onconova-ext-cancer-morphology"
    ] = Field(
...
class CancerTopography(FHIRSliceModel):
    ...
    url: Literal[
        "http://onconova.github.io/fhir/StructureDefinition/onconova-ext-cancer-topography"
    ] = Field(
        description="identifies the meaning of the extension",
...
class CancerCondition(BackboneElement):
    ...
    extension: Optional[
        List[
            Annotated[
                Union[CancerMorphology, CancerTopography, Extension],
...
class CancerTopography(FHIRBaseModel):
    ...
    condition: Optional[
        List[
            Annotated[
                Union[CancerCondition, BackboneElement],
                Field(union_mode="left_to_right"),
            ]
        ]
    ] = Field(
