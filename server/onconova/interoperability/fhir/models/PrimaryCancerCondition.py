# Code autogenerated by Fhircraft 0.3.6 on 2025-11-22 15:19:51.242595.
...
class HistologicalDifferentiation(FHIRSliceModel):
    ...
    url: Literal['http://onconova.github.io/fhir/StructureDefinition/onconova-ext-histological-differentiation'] = Field(
        description="identifies the meaning of the extension",
...
class PrimaryCancerRecurrenceType(FHIRSliceModel):
    ...
    url: Literal['http://onconova.github.io/fhir/StructureDefinition/onconova-ext-primary-cancer-recurrence-type'] = Field(
        description="identifies the meaning of the extension",
...
class PrimaryCancerRecurrenceOf(FHIRSliceModel):
    ...
    url: Literal['http://onconova.github.io/fhir/StructureDefinition/onconova-ext-primary-cancer-recurrence-of'] = Field(
        description="identifies the meaning of the extension",
...
PrimaryCancerRecurrenceType.model_rebuild()
PrimaryCancerRecurrenceOf.model_rebuild()
OnconovaPrimaryCancerConditionClinicalStatus.model_rebuild()
OnconovaPrimaryCancerConditionUsCore.model_rebuild()
OnconovaPrimaryCancerConditionScreeningAssessment.model_rebuild()
BodyLocationQualifier.model_rebuild()
LateralityQualifier.model_rebuild()
OnconovaPrimaryCancerConditionBodySite.model_rebuild()
OnconovaPrimaryCancerConditionStage.model_rebuild()
OnconovaPrimaryCancerConditionEvidence.model_rebuild()
OnconovaPrimaryCancerCondition.model_rebuild()
