# Code autogenerated by Fhircraft 0.3.5 on 2025-11-19 19:01:20.528752.
...
class Differentiation(FHIRSliceModel):
    """
    ...
    url: Literal['http://onconova.github.io/fhir/StructureDefinition/onconova-ext-differentiation'] = Field(
        description="identifies the meaning of the extension",
        default="http://onconova.github.io/fhir/StructureDefinition/onconova-ext-differentiation",
    )
    valueCodeableConcept: Optional[CodeableConcept] = Field(
        description="Value of extension",
        default=None,
...
```
    ...
    extension: Optional[List[Annotated[Union[ConditionAssertedDate, HistologyMorphologyBehavior, Differentiation, RecurrenceOf, Extension], Field(union_mode='left_to_right')]]] = Field(
        description="Extension",
        default=None,
    )
...
RecurrenceOf.model_rebuild()
RecurrenceType.model_rebuild()
