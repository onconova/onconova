# Code autogenerated by Fhircraft 0.3.1 on 2025-10-09 07:26:41.595468.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Element,Meta,Narrative,Resource,Extension,CodeableConcept,Reference,Identifier,Age,Period,Range,BackboneElement,Annotation
...
class RecurrenceOf(FHIRSliceModel):
    ...
    url: Literal['http://luisfabib.github.io/onconova/StructureDefinition/onconova-ext-recurrence-of'] = Field(
        description="identifies the meaning of the extension",
        default="http://luisfabib.github.io/onconova/StructureDefinition/onconova-ext-recurrence-of",
    )
    ...
    @model_validator(mode="after")
    def FHIR_recurrence_reference_constraint_model_validator(self):
        return validate_model_constraint( 
            self,
...
class RecurrenceOfBodySite(CodeableConcept):
    """
...
It constrains the mCODE [PrimaryCancerCCondition profile](http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-primary-cancer-condition) to constrain the terminologies of the cancer topography and morphology extensions to use exclusively ICD-O-3 codes.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='0.1.0', profile=['http://luisfabib.github.io/onconova/StructureDefinition/onconova-primary-cancer-condition']),
    )
    ...
    category: Optional[List[Annotated[Union[UsCore, ScreeningAssessment, CodeableConcept], Field(union_mode='left_to_right')]]] = Field(
    ...
    code: CodeableConcept = Field(
        ...
        default_factory=lambda: CodeableConcept(coding=[{'system': 'http://snomed.info/sct', 'code': '363346000', 'display': 'Malignant neoplastic disease'}]),
    )
    bodySite: Optional[List[RecurrenceOfBodySite]] = Field(
    ...
    def FHIR_code_pattern_constraint(cls, value):    
        return validate_FHIR_element_pattern(cls, value, 
            pattern=CodeableConcept(coding=[{'system': 'http://snomed.info/sct', 'code': '363346000', 'display': 'Malignant neoplastic disease'}]),
        )
