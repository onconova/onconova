# Code autogenerated by Fhircraft 0.3.1 on 2025-10-09 07:26:50.520345.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Element,Meta,Narrative,Resource,Extension,Identifier,Reference,CodeableConcept,Period,Timing,Annotation,BackboneElement,Quantity,Range
...
class LymphaticInvasionCategory(Reference):
    """
...
class PerineuralInvasionCategory(Reference):
    """
    Element containing the T, N, and M categories as references to separate T, N, M observations. The referenced resources are observations leading to the Stage Group reported in the current resource.
    """
    pass
...
class ResidualTumorCategory(Reference):
    """
    Element containing the T, N, and M categories as references to separate T, N, M observations. The referenced resources are observations leading to the Stage Group reported in the current resource.
    """
    pass
...
class SerumTumorMarkerLevelCategory(Reference):
    """
    Element containing the T, N, and M categories as references to separate T, N, M observations. The referenced resources are observations leading to the Stage Group reported in the current resource.
    """
    pass
...
class VenousInvasionCategory(Reference):
    """
    Element containing the T, N, and M categories as references to separate T, N, M observations. The referenced resources are observations leading to the Stage Group reported in the current resource.
    """
    pass
...
class OnconovaTNMStageGroupComponent(BackboneElement):
    ...
    @field_validator(*('interpretation', 'dataAbsentReason', 'code', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
It extends the base mCODE [TNMStageGroup profile](http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-tnm-stage-group) to expand the TNM subcategories and include specific constraints and extensions relevant to Onconova.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='0.1.0', profile=['http://luisfabib.github.io/onconova/StructureDefinition/onconova-tnm-stage-group']),
    )
    ...
    hasMember: Optional[List[Annotated[Union[TNMCategory, LymphaticInvasionCategory, PerineuralInvasionCategory, ResidualTumorCategory, SerumTumorMarkerLevelCategory, GradeCategory, VenousInvasionCategory, Reference], Field(union_mode='left_to_right')]]] = Field(
