...
class OnconovaTNMStageGroup(FHIRBaseModel):
    ...
    category: Optional[
        List[
            Annotated[Union[UsCore, CodeableConcept], Field(union_mode="left_to_right")]
        ]
    ] = Field(
        ...
        List[
            Annotated[
                Union[
                    ...
                    PerineuralInvasionCategory,
                    ResidualTumorCategory,
                    SerumTumorMarkerLevelCategory,
                    GradeCategory,
                    VenousInvasionCategory,
                    Reference,
                ],
