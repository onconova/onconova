# Code autogenerated by Fhircraft 0.3.5 on 2025-11-19 19:01:22.729106.
...
from fhircraft.fhir.resources.validators import validate_element_constraint,get_type_choice_value_by_base,validate_type_choice_element,validate_FHIR_element_pattern,validate_slicing_cardinalities,validate_contained_resource,validate_model_constraint
 
class OnconovaTNMStageGroupUsCore(CodeableConcept):
    """
...
class OnconovaTNMStageGroupReferenceRange(BackboneElement):
    """
...
class OnconovaTNMStageGroupTNMCategory(Reference):
    """
    Prognostic factors contributing to stage determination.
    """
    pass
    
 
class OnconovaTNMStageGroupLymphaticInvasionCategory(Reference):
    """
    Element containing the T, N, and M categories as references to separate T, N, M observations. The referenced resources are observations leading to the Stage Group reported in the current resource.
    """
    pass
    
 
class OnconovaTNMStageGroupPerineuralInvasionCategory(Reference):
    """
    Element containing the T, N, and M categories as references to separate T, N, M observations. The referenced resources are observations leading to the Stage Group reported in the current resource.
    """
    pass
...
class OnconovaTNMStageGroupResidualTumorCategory(Reference):
    """
    Element containing the T, N, and M categories as references to separate T, N, M observations. The referenced resources are observations leading to the Stage Group reported in the current resource.
    """
    pass
...
class OnconovaTNMStageGroupSerumTumorMarkerLevelCategory(Reference):
    """
    Element containing the T, N, and M categories as references to separate T, N, M observations. The referenced resources are observations leading to the Stage Group reported in the current resource.
    """
    pass
...
class OnconovaTNMStageGroupGradeCategory(Reference):
    """
    Element containing the T, N, and M categories as references to separate T, N, M observations. The referenced resources are observations leading to the Stage Group reported in the current resource.
    """
    pass
...
class OnconovaTNMStageGroupVenousInvasionCategory(Reference):
    """
    Element containing the T, N, and M categories as references to separate T, N, M observations. The referenced resources are observations leading to the Stage Group reported in the current resource.
    """
    pass
...
class OnconovaTNMStageGroupComponentReferenceRange(BackboneElement):
    """
...
class OnconovaTNMStageGroupComponent(BackboneElement):
    """
    Not used in this profile
    """
    ...
    referenceRange: Optional[List[OnconovaTNMStageGroupComponentReferenceRange]] = Field(
...
class OnconovaTNMStageGroup(FHIRBaseModel):
    """
...
It extends the base mCODE [TNMStageGroup profile](http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-tnm-stage-group) to expand the TNM subcategories and include specific constraints and extensions relevant to Onconova.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-tnm-stage-group'], versionId="0.2.0"),
    )
    ...
    category: Optional[List[Annotated[Union[OnconovaTNMStageGroupUsCore, CodeableConcept], Field(union_mode='left_to_right')]]] = Field(
    ...
    referenceRange: Optional[List[OnconovaTNMStageGroupReferenceRange]] = Field(
        description="Not used in this profile",
        default=None,
    )
    hasMember: Optional[List[Annotated[Union[OnconovaTNMStageGroupTNMCategory, OnconovaTNMStageGroupLymphaticInvasionCategory, OnconovaTNMStageGroupPerineuralInvasionCategory, OnconovaTNMStageGroupResidualTumorCategory, OnconovaTNMStageGroupSerumTumorMarkerLevelCategory, OnconovaTNMStageGroupGradeCategory, OnconovaTNMStageGroupVenousInvasionCategory, Reference], Field(union_mode='left_to_right')]]] = Field(
    ...
    component: Optional[List[OnconovaTNMStageGroupComponent]] = Field(
        description="Not used in this profile",
        default=None,
    )
...
OnconovaTNMStageGroupTNMCategory.model_rebuild()
OnconovaTNMStageGroupLymphaticInvasionCategory.model_rebuild()
OnconovaTNMStageGroupPerineuralInvasionCategory.model_rebuild()
OnconovaTNMStageGroupResidualTumorCategory.model_rebuild()
OnconovaTNMStageGroupSerumTumorMarkerLevelCategory.model_rebuild()
OnconovaTNMStageGroupGradeCategory.model_rebuild()
OnconovaTNMStageGroupVenousInvasionCategory.model_rebuild()
