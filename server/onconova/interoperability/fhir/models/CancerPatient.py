...
class USCoreRaceExtension(FHIRSliceModel):
    ...
    extension: Optional[
        List[
            Annotated[
                Union[OmbCategory, Detailed, Text, Extension],
...
class USCoreTribalAffiliationExtension(FHIRSliceModel):
    ...
    extension: Optional[
        List[
            Annotated[
                Union[TribalAffiliation, IsEnrolled, Extension],
                Field(union_mode="left_to_right"),
            ]
        ]
    ] = Field(
...
class AnonymizedEntry(FHIRSliceModel):
    ...
    url: Literal[
        "http://onconova.github.io/fhir/StructureDefinition/onconova-ext-anonymized-entry"
    ] = Field(
        description="identifies the meaning of the extension",
...
class EndOfRecordsName(HumanName):
    ...
    extension: Optional[
        List[
            Annotated[
                Union["CancerPatient", Extension], Field(union_mode="left_to_right")
            ]
        ]
    ] = Field(
        description=None,
...
class CancerPatient(FHIRBaseModel):
    ...
    identifier: Optional[
        List[
            Annotated[
                Union[OnconovaIdentifier, Identifier], Field(union_mode="left_to_right")
            ]
        ]
    ] = Field(
