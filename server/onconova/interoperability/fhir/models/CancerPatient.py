# Code autogenerated by Fhircraft 0.3.4 on 2025-11-11 15:53:51.627309.
...
class AnonymizedEntry(FHIRSliceModel):
    ...
    url: Literal['http://onconova.github.io/fhir/StructureDefinition/onconova-ext-anonymized-entry'] = Field(
        description="identifies the meaning of the extension",
        default="http://onconova.github.io/fhir/StructureDefinition/onconova-ext-anonymized-entry",
    )
    valueCode: Optional[Code] = Field(
        description="Value of extension",
        default=None,
