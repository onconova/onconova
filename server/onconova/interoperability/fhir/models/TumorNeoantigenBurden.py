# Code autogenerated by Fhircraft 0.5.0 on 2026-02-23 17:27:03.174639.
...
class OnconovaTumorNeoantigenBurden(GenomicsBase):
    """
...
Observation resources representing a tumor neoantigen burden obtained through genomic testing in the scope of Onconova SHALL conform to this profile. Any resource intended to conform to this profile SHOULD populate `meta.profile` accordingly. 
    ...
    _canonical_url = "http://onconova.github.io/fhir/StructureDefinition/onconova-tumor-neoantigen-burden"

    meta: Optional[Meta] = Field(
        title="Meta",
        description="Metadata about the resource.",
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-tumor-neoantigen-burden']),
    )
    ...
    code: Optional[CodeableConcept] = Field(
        ...
        default_factory=lambda: CodeableConcept(coding=[Coding(code="tumor-neoantigen-burden", display="Tumor Neoantigen Burden", system="http://onconova.github.io/fhir/CodeSystem/onconova-cs-tbd")]),
    )
    ...
    def FHIR_code_pattern_constraint(cls, value):    
        return validate_FHIR_element_pattern(cls, value, 
            pattern=CodeableConcept(coding=[Coding(code="tumor-neoantigen-burden", display="Tumor Neoantigen Burden", system="http://onconova.github.io/fhir/CodeSystem/onconova-cs-tbd")]),
        )
