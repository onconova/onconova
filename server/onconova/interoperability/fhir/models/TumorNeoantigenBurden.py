# Code autogenerated by Fhircraft 0.4.1 on 2025-12-04 08:14:53.252095.
...
class OnconovaTumorNeoantigenBurdenLabCategory(CodeableConcept, FHIRSliceModel):
    """
...
class OnconovaTumorNeoantigenBurdenConclusionStringComponentReferenceRange(
    BackboneElement
):
    """
...
class OnconovaTumorNeoantigenBurdenConclusionString(BackboneElement, FHIRSliceModel):
    """
    Clinical Conclusion
    """
    ...
    referenceRange: Optional[
        List[OnconovaTumorNeoantigenBurdenConclusionStringComponentReferenceRange]
    ] = Field(
...
class OnconovaTumorNeoantigenBurden(DomainResource):
    ...
    **Conformance:**
    ...
    category: Optional[
        List[
            Annotated[
                Union[OnconovaTumorNeoantigenBurdenLabCategory, CodeableConcept],
                Field(union_mode="left_to_right"),
            ]
        ]
    ] = Field(
    ...
    component: Optional[
        List[
            Annotated[
                Union[OnconovaTumorNeoantigenBurdenConclusionString, BackboneElement],
                Field(union_mode="left_to_right"),
            ]
        ]
    ] = Field(
