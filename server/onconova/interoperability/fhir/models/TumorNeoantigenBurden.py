# Code autogenerated by Fhircraft 0.3.3 on 2025-11-07 18:12:59.365540.
...
class OnconovaTumorNeoantigenBurdenLabCategory(CodeableConcept):
    """
...
class OnconovaTumorNeoantigenBurdenReferenceRange(BackboneElement):
    """
...
class OnconovaTumorNeoantigenBurdenConclusionStringComponentReferenceRange(BackboneElement):
    """
...
class OnconovaTumorNeoantigenBurdenConclusionString(BackboneElement):
    """
    Clinical Conclusion
    """
    extension: Optional[List[Extension]] = Field(
    ...
    referenceRange: Optional[List[OnconovaTumorNeoantigenBurdenConclusionStringComponentReferenceRange]] = Field(
...
This profile extends the GenomicsReporting IG [GenomicsBase profile](http://hl7.org/fhir/uv/genomics-reporting/StructureDefinition/genomics-base) to include specific constraints and extensions relevant to Onconova.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-tumor-neoantigen-burden'], versionId="0.2.0"),
    )
    ...
    category: Optional[List[Annotated[Union[OnconovaTumorNeoantigenBurdenLabCategory, CodeableConcept], Field(union_mode='left_to_right')]]] = Field(
    ...
    referenceRange: Optional[List[OnconovaTumorNeoantigenBurdenReferenceRange]] = Field(
    ...
    component: Optional[List[Annotated[Union[OnconovaTumorNeoantigenBurdenConclusionString, BackboneElement], Field(union_mode='left_to_right')]]] = Field(
