# Code autogenerated by Fhircraft 0.3.1 on 2025-10-09 07:26:44.155229.
...
This profile extends the GenomicsReporting IG [GenomicsBase profile](http://hl7.org/fhir/uv/genomics-reporting/StructureDefinition/genomics-base) to include specific constraints and extensions relevant to Onconova.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='0.1.0', profile=['http://luisfabib.github.io/onconova/StructureDefinition/onconova-tumor-neoantigen-burden']),
    )
    ...
    code: CodeableConcept = Field(
        ...
        default_factory=lambda: CodeableConcept(coding=[{'system': 'http://luisfabib.github.io/onconova/CodeSystem/onconova-cs-tbd', 'code': 'tumor-neoantigen-burden', 'display': 'Tumor Neoantigen Burden'}]),
    )
    ...
    def FHIR_code_pattern_constraint(cls, value):    
        return validate_FHIR_element_pattern(cls, value, 
            pattern=CodeableConcept(coding=[{'system': 'http://luisfabib.github.io/onconova/CodeSystem/onconova-cs-tbd', 'code': 'tumor-neoantigen-burden', 'display': 'Tumor Neoantigen Burden'}]),
        )
