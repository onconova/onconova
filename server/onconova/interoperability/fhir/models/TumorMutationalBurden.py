# Code autogenerated by Fhircraft 0.3.4 on 2025-11-11 15:54:09.727882.
...
class OnconovaTumorMutationalBurdenLabCategory(CodeableConcept):
    """
...
class OnconovaTumorMutationalBurdenReferenceRange(BackboneElement):
    """
...
class OnconovaTumorMutationalBurdenConclusionStringComponentReferenceRange(BackboneElement):
    """
...
class OnconovaTumorMutationalBurdenConclusionString(BackboneElement):
    """
    Clinical Conclusion
    """
    extension: Optional[List[Extension]] = Field(
    ...
    referenceRange: Optional[List[OnconovaTumorMutationalBurdenConclusionStringComponentReferenceRange]] = Field(
...
class OnconovaTumorMutationalBurden(FHIRBaseModel):
    """
...
This profile extends the GenomicsReporting IG [TumorMutationalBurden profile](http://hl7.org/fhir/uv/genomics-reporting/StructureDefinition/tmb) to include specific constraints and extensions relevant to Onconova.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-tumor-mutational-burden'], versionId="0.2.0"),
    )
    ...
    category: Optional[List[Annotated[Union[OnconovaTumorMutationalBurdenLabCategory, CodeableConcept], Field(union_mode='left_to_right')]]] = Field(
    ...
    referenceRange: Optional[List[OnconovaTumorMutationalBurdenReferenceRange]] = Field(
    ...
    component: Optional[List[Annotated[Union[OnconovaTumorMutationalBurdenConclusionString, BackboneElement], Field(union_mode='left_to_right')]]] = Field(
