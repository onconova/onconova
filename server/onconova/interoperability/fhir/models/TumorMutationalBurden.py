# Code autogenerated by Fhircraft 0.5.0 on 2026-02-23 17:27:24.001437.
...
class TMB(GenomicsBase):
    ...
    meta: Optional[Meta] = Field(
        title="Meta",
        description="Metadata about the resource.",
        default_factory=lambda: Meta(profile=['http://hl7.org/fhir/uv/genomics-reporting/StructureDefinition/tmb']),
    )
    code: Optional[CodeableConcept] = Field(
        description="94076-7",
        default_factory=lambda: CodeableConcept(coding=[Coding(code="94076-7", system="http://loinc.org")]),
    )
    ...
    def FHIR_code_pattern_constraint(cls, value):    
        return validate_FHIR_element_pattern(cls, value, 
            pattern=CodeableConcept(coding=[Coding(code="94076-7", system="http://loinc.org")]),
        )
        
 
class TumorMutationalBurdenStatus(Extension, FHIRSliceModel):
    """
    ...
    _canonical_url = "http://onconova.github.io/fhir/StructureDefinition/onconova-ext-tumor-mutational-burden-status"
    ...
    url: Optional[String] = Field(
        description="identifies the meaning of the extension",
        default="http://onconova.github.io/fhir/StructureDefinition/onconova-ext-tumor-mutational-burden-status",
    )
    ...
    def FHIR_url_fixed_value_constraint(cls, value):    
        return validate_FHIR_element_fixed_value(cls, value, 
            constant="http://onconova.github.io/fhir/StructureDefinition/onconova-ext-tumor-mutational-burden-status",
        )
...
Observation resources representing a tumor mutational burden obtained through genomic testing in the scope of Onconova SHALL conform to this profile. Any resource intended to conform to this profile SHOULD populate `meta.profile` accordingly. 
    ...
    meta: Optional[Meta] = Field(
        title="Meta",
        description="Metadata about the resource.",
        default_factory=lambda: Meta(profile=['http://onconova.github.io/fhir/StructureDefinition/onconova-tumor-mutational-burden']),
    )
    extension: Optional[List[Annotated[Union[TumorMutationalBurdenStatus, Extension], Field(union_mode='left_to_right')]]] = Field(
