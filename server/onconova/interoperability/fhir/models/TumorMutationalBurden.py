# Code autogenerated by Fhircraft 0.4.1 on 2025-12-04 08:15:09.253721.
...
class TumorMutationalBurdenStatus(FHIRSliceModel):
    """
...
class OnconovaTumorMutationalBurdenLabCategory(CodeableConcept, FHIRSliceModel):
    """
...
class OnconovaTumorMutationalBurdenConclusionStringComponentReferenceRange(
    BackboneElement
):
    """
...
class OnconovaTumorMutationalBurdenConclusionString(BackboneElement, FHIRSliceModel):
    """
    Clinical Conclusion
    """
    ...
    referenceRange: Optional[
        List[OnconovaTumorMutationalBurdenConclusionStringComponentReferenceRange]
    ] = Field(
...
class OnconovaTumorMutationalBurden(DomainResource):
    """
    ...
    **Conformance:**
    ...
    category: Optional[
        List[
            Annotated[
                Union[OnconovaTumorMutationalBurdenLabCategory, CodeableConcept],
                Field(union_mode="left_to_right"),
            ]
        ]
    ] = Field(
    ...
    component: Optional[
        List[
            Annotated[
                Union[OnconovaTumorMutationalBurdenConclusionString, BackboneElement],
                Field(union_mode="left_to_right"),
            ]
        ]
    ] = Field(
