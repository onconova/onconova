# Code autogenerated by Fhircraft 0.5.0 on 2026-04-11 19:03:19.064614.
...
from fhircraft.fhir.resources.datatypes.R4.primitive.uri import Uri, uri
...
from fhircraft.fhir.resources.datatypes.R4.primitive import DateTime, Id, Instant, String
from fhircraft.fhir.resources.datatypes.R4.primitive.code import Code, code
...
class TMBValueQuantity(Quantity):
    ...
    unit: Optional[String] = Field(
        ...
        default_factory=lambda: 'Mutations/Megabase',
    )
    ...
    code: Optional[code] = Field(
        ...
        default_factory=lambda: '1/1000000{Base}',
    )
    ...
    @model_validator(mode="after")
    def FHIR_ValueQuantity_pattern_constraint(self):
        return validate_FHIR_model_pattern( 
            self,
            pattern=Quantity(code='1/1000000{Base}', system='http://unitsofmeasure.org'),
        )
...
class TMB(GenomicsBase):
    ...
    valueQuantity: Optional[TMBValueQuantity] = Field(
        description="The information determined as a result of making the observation, if the information has a simple value.",
        default_factory=lambda: Quantity(code='1/1000000{Base}', system='http://unitsofmeasure.org'),
    )
...
class TumorMutationalBurdenStatus(Extension):
    """
    ...
    url: Optional[Uri] = Field(
        description="Source of the definition for the extension code - a logical name or a URL.",
        default_factory=lambda: 'http://onconova.github.io/fhir/StructureDefinition/onconova-ext-tumor-mutational-burden-status',
    )
    valueCodeableConcept: Optional[CodeableConcept] = Field(
        description="Value of extension - must be one of a constrained set of the data types (see [Extensibility](extensibility.html) for a list).",
        default=None,
...
class OnconovaTumorMutationalBurdenStatus(TumorMutationalBurdenStatus, FHIRSliceModel):
    """
    An Extension
    """
    min_cardinality: ClassVar[int] = 0
...
class OnconovaTumorMutationalBurden(TMB):
    ...
    extension: Optional[list[Union[GenomicsBaseSecondaryFinding, GenomicsBaseBodyStructure, OnconovaTumorMutationalBurdenStatus, Extension]]] = Field(
