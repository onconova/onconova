    ...
    def fhir_to_onconova(
        ...
        return schemas.TumorMarkerCreate(
            ...
            analyte=CodedConcept.model_validate(
                obj.fhirpath_single("Observation.extension('http://onconova.github.io/fhir/StructureDefinition/onconova-ext-tumor-marker-analyte').valueCodeableConcept.coding")
            ),
            relatedEntitiesIds=[
                ref.replace("Condition/", "") for ref in 
                obj.fhirpath_values("Observation.extension('http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-related-condition').valueReference.reference")
            ],
            massConcentration=Measure(
                value=(quantity := obj.fhirpath_single("Observation.valueQuantity")).value, 
                unit=ucum_to_internal(quantity.code)
            ) if result_type == AnalyteResultType.mass_concentration else None,
            arbitraryConcentration=Measure(
                value=(quantity := obj.fhirpath_single("Observation.valueQuantity")).value, 
                unit=ucum_to_internal(quantity.code)
            ) if result_type == AnalyteResultType.arbitary_concentration else None,
            substanceConcentration=Measure(
                value=(quantity := obj.fhirpath_single("Observation.valueQuantity")).value, 
                unit=ucum_to_internal(quantity.code)
            ) if result_type == AnalyteResultType.substance_concentration else None, 
            fraction=Measure(
                value=(quantity := obj.fhirpath_single("Observation.valueQuantity")).value, 
                unit=ucum_to_internal(quantity.code)
            ) if result_type == AnalyteResultType.fraction else None,
            multipleOfMedian=Measure(
                value=(quantity := obj.fhirpath_single("Observation.valueQuantity")).value, 
                unit=ucum_to_internal(quantity.code)
            ) if result_type == AnalyteResultType.multiple_of_median else None,
            tumorProportionScore=obj.fhirpath_single("Observation.valueString") if result_type == AnalyteResultType.tumor_proportion_score else None,
            immuneCellScore=obj.fhirpath_single("Observation.valueString") if result_type == AnalyteResultType.immmune_cells_score else None,
            combinedPositiveScore=Measure(
                value=(quantity := obj.fhirpath_single("Observation.valueQuantity")).value, 
                unit=ucum_to_internal(quantity.code)
            ) if result_type == AnalyteResultType.combined_positive_score else None,
            immunohistochemicalScore=obj.fhirpath_single("Observation.valueString") if result_type == AnalyteResultType.immunohistochemical_score else None,
            presence=obj.fhirpath_single("Observation.valueString") if result_type == AnalyteResultType.presence else None, 
            nuclearExpressionStatus=obj.fhirpath_single("Observation.valueString") if result_type == AnalyteResultType.nuclear_expression_status else None,
        )

    @classmethod
    def onconova_to_fhir(
        cls, obj: schemas.TumorMarker
        ...
        resource.extension = [
            fhir.TumorMarkerAnalyte(
                valueCodeableConcept=CodeableConcept(coding=[Coding.model_validate(obj.analyte.model_dump())])
            )
        ]
...
TumorMarkerProfile.register_mapping(
    ...
    [   
        ...
        MappingRule(
            dict(code="LP28643-2", result_type=AnalyteResultType.arbitary_concentration),
            Coding(
                code="19166-8",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP28643-2", result_type=AnalyteResultType.substance_concentration),
            Coding(
                code="19167-6",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP14543-0", result_type=AnalyteResultType.arbitary_concentration),
            Coding(
                code="40618-1",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP15461-4", result_type=AnalyteResultType.arbitary_concentration),
            Coding(
                code="10334-1",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP14040-7", result_type=AnalyteResultType.arbitary_concentration),
            Coding(
                code="24108-3",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP15463-0", result_type=AnalyteResultType.arbitary_concentration),
            Coding(
                code="2011-5",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP15464-8", result_type=AnalyteResultType.arbitary_concentration),
            Coding(
                code="17842-6",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP15465-5", result_type=AnalyteResultType.arbitary_concentration),
            Coding(
                code="34256-8",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP15466-3", result_type=AnalyteResultType.arbitary_concentration),
            Coding(
                code="19189-0",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP15467-1", result_type=AnalyteResultType.arbitary_concentration),
            Coding(
                code="17843-4",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP28642-4", result_type=AnalyteResultType.arbitary_concentration),
            Coding(
                code="24474-9",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP135291-5", result_type=AnalyteResultType.arbitary_concentration),
            Coding(
                code="C96593",
        ...
        MappingRule(
            dict(code="LP40488-6", result_type=AnalyteResultType.arbitary_concentration),
            Coding(
                code="46699-5",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP89249-4", result_type=AnalyteResultType.arbitary_concentration),
            Coding(
                code="54165-6",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP38032-6", result_type=AnalyteResultType.arbitary_concentration),
            Coding(
                code="19193-2",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP15033-1", result_type=AnalyteResultType.arbitary_concentration),
            Coding(
                code="2532-0",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP14652-9", result_type=AnalyteResultType.substance_concentration),
            Coding(
                code="25587-7",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP18193-0", result_type=AnalyteResultType.arbitary_concentration),
            Coding(
                code="19195-7",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP18193-0", result_type=AnalyteResultType.substance_concentration),
            Coding(
                code="19197-3",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP14331-0", result_type=AnalyteResultType.arbitary_concentration),
            Coding(
                code="19176-7",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP14331-0", result_type=AnalyteResultType.substance_concentration),
            Coding(
                code="19177-5",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP14329-4", result_type=AnalyteResultType.arbitary_concentration),
            Coding(
                code="21198-7",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP14329-4", result_type=AnalyteResultType.substance_concentration),
            Coding(
                code="2111-3",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP19423-0", result_type=AnalyteResultType.arbitary_concentration),
            Coding(
                code="19182-5",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP93517-8", result_type=AnalyteResultType.substance_concentration),
            Coding(
                code="55180-4",
                system="http://loinc.org",
        ...
        # Melanin (Mel)
        MappingRule(
            dict(code="LP15724-5", result_type=AnalyteResultType.arbitary_concentration),
            Coding(
                code="17248-6",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP38066-4", result_type=AnalyteResultType.arbitary_concentration),
            Coding(
                code="13238-1",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP220351-3", result_type=AnalyteResultType.tumor_proportion_score),
            Coding(
                code="C184941",
                system="http://ncicb.nci.nih.gov/xml/owl/EVS/Thesaurus.owl",
        ...
        MappingRule(
            dict(code="LP220351-3", result_type=AnalyteResultType.combined_positive_score),
            Coding(
                code="C176582",
                system="http://ncicb.nci.nih.gov/xml/owl/EVS/Thesaurus.owl",
        ...
        MappingRule(
            dict(code="LP28442-9", result_type=AnalyteResultType.immunohistochemical_score),
            Coding(
                code="C185751",
                system="http://ncicb.nci.nih.gov/xml/owl/EVS/Thesaurus.owl",
        ...
        MappingRule(
            dict(code="LP420961-7", result_type=AnalyteResultType.nuclear_expression_status),
            Coding(
                code="96272-0",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP212189-7", result_type=AnalyteResultType.nuclear_expression_status),
            Coding(
                code="81691-8",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP212190-5", result_type=AnalyteResultType.nuclear_expression_status),
            Coding(
                code="81692-6",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP212191-3", result_type=AnalyteResultType.nuclear_expression_status),
            Coding(
                code="81693-4",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP212192-1", result_type=AnalyteResultType.nuclear_expression_status),
            Coding(
                code="81694-2",
                system="http://loinc.org",
        ...
        MappingRule(
            dict(code="LP38067-2", result_type=AnalyteResultType.arbitary_concentration),
            Coding(
                code="108217-1",
                system="http://loinc.org",
