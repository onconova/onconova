...
class TreatmentResponse(BaseModel):
    ...
    case = models.ForeignKey(
        ...
        help_text = _("Indicates the case of the patient who's treatment response is asseessed"),
        to = PatientCase,
    ...
    assessed_entities = models.ManyToManyField(
        ...
        help_text = _("References to the neoplastic entities that were assesed for treatment response"),
        to = NeoplasticEntity,
        related_name = 'treatment_responses',
    )
    ...
    recist_interpreted = models.BooleanField(
        ...
        help_text=_("Indicates whether the RECIST value was interpreted or taken from the radiology report"),
