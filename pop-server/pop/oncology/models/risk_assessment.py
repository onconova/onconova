...
class RiskAssessment(BaseModel):
    ...
    date = models.DateField(
        ...
        help_text=_("Clinically-relevant date at which the risk assessment was performed and recorded."),
    ) 
    assessed_entities = models.ManyToManyField(
        verbose_name = _('Assessed neoplastic entities'),
        help_text = _("References to the neoplastic entities that were assessed to estimate the risk."),
        to = NeoplasticEntity,
        related_name = 'risk_assessments',
    )
