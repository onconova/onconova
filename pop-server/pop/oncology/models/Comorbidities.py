...
class ElixhauserPanelDetails(ComorbiditiesPanelDetails): 
    ...
    categories = dict(
        chf = ComorbidityPanelCategory(
            ...
            codes=["I09.9", "I11.0", "I13.0", "I13.2", "I25.5", "I42.0", "I42.5", "I42.6", "I42.7", "I42.8", "I42.9", "I43", "I50", "P29.0"],
            weight=7,
        ),
        ...
        valv = ComorbidityPanelCategory(
            ...
            codes=["A52.0", "I05", "I06", "I07", "I08", "I09.1", "I09.8", "I34", "I35", "I36", "I37", "I38", "I39", "Q23.0", "Q23.1", "Q23.2", "Q23.3", "Z95.2", "Z95.3", "Z95.4"],
            weight=-1,
        ),
        ...
        cpd = ComorbidityPanelCategory(
            ...
            codes=["I27.8", "I27.9", "J40", "J41", "J42", "J43", "J44", "J45", "J46", "J47", "J60", "J61", "J62", "J63", "J64", "J65", "J66", "J67", "J68.4", "J70.1", "J70.3"],
            weight=3,
        ),
        ...
        pud = ComorbidityPanelCategory(
            ...
            codes=["K25.7", "K25.9", "K26.7", "K26.9", "K27.7", "K27.9", "K28.7", "K28.9"],
            weight=0,
        ),
        ...
        rheumd = ComorbidityPanelCategory(
            ...
            codes=["L94.0", "L94.1", "L94.3", "M05", "M06", "M08", "M12.0", "M12.3", "M30", "M31.0", "M31.1", "M31.2", "M31.3", "M32", "M33", "M34", "M35", "M45", "M46.1", "M46.8", "M46.9"],
            weight=0,
        ),
        coag = ComorbidityPanelCategory(
            label='Coagulopathy',
            codes=["D65", "D66", "D67", "D68", "D69.1", "D69.3", "D69.4", "D69.5", "D69.6"],
            weight=3,
        ),
...
class CharlsonPanelDetails(ComorbiditiesPanelDetails): 
    ...
    categories = dict(
        ...
        rhematic_disease = ComorbidityPanelCategory(
...
class ComorbiditiesAssessment(BaseModel):
    ...
    present = termfields.CodedConceptField(
    ...
    absent = termfields.CodedConceptField(
    ...
    def score(self):
        if not self.panel:
            return None 
        present_comorbidities_codes = list(self.present.all().values_list('code'))
    ...
    def description(self):
        if self.panel:
            ...
            return f'Comorbidities: {self.present.count()} present and {self.absent.count()} absent'
