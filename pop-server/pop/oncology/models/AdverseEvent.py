...
class AdverseEvent(BaseModel):
    ...
    case = models.ForeignKey(
        ...
        help_text = _("Indicates the case of the patient who had the adverse event being recorded"),
        to = PatientCase,
    ...
    is_resolved = models.GeneratedField(
        ...
        expression = models.Case(
                models.When(models.Q(outcome = AdverseEventOutcome.RESOLVED) | models.Q(outcome = AdverseEventOutcome.RESOLVED_WITH_SEQUELAE), then = models.Value(True)),  
...
class AdverseEventSuspectedCause(BaseModel):
    ...
    medication = models.ForeignKey(
        ...
        help_text = _("Systemic therapy medication suspected to be the cause of the adverse event"),
    ...
    @property
    def cause(self):
        return self.systemic_therapy or self.medication or self.radiotherapy or self.surgery
...
class AdverseEventMitigation(BaseModel): 
    ...
    adjustment = termfields.CodedConceptField( 
        ...
        help_text = _('Classification of the adjustment of systemic anti-cancer treatment used to mitigate the adverse event (if applicable)'),
    ...
    drug = termfields.CodedConceptField( 
        ...
        help_text = _('Classification of the pharmacological treatment used to mitigate the adverse event (if applicable)'),
        terminology = terminologies.AdverseEventMitigationDrug,
        null=True, blank=True,
    )
    procedure = termfields.CodedConceptField( 
        verbose_name = _('Procedure'),
        help_text = _('Classification of the non-pharmacological procedure used to mitigate the adverse event (if applicable)'),
