...
class Surgery(BaseModel):
    ...
    case = models.ForeignKey(
        ...
        help_text = _("Indicates the case of the patient who received the surgical procedure"),
        to = PatientCase,
    ...
    targeted_entities = models.ManyToManyField(
        ...
        help_text = _("References to the neoplastic entities that were targeted by the surgery"),
        to = NeoplasticEntity,
        related_name = 'surgeries',
    )
