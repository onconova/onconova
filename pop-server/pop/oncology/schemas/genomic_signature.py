...
class GenomicSignatureSchema(ModelGetSchema):
    ...
    config = SchemaConfig(model=orm.GenomicSignature, anonymization=AnonymizationConfig(fields=['date'], key='caseId'))
...
class TumorMutationalBurdenSchema(ModelGetSchema):
    ...
    config = SchemaConfig(model=orm.TumorMutationalBurden, exclude=['genomic_signature'], anonymization=AnonymizationConfig(fields=['date'], key='caseId'))
...
class MicrosatelliteInstabilitySchema(ModelGetSchema):
    ...
    config = SchemaConfig(model=orm.MicrosatelliteInstability, exclude=['genomic_signature'], anonymization=AnonymizationConfig(fields=['date'], key='caseId'))
...
class LossOfHeterozygositySchema(ModelGetSchema):
    ...
    config = SchemaConfig(model=orm.LossOfHeterozygosity, exclude=['genomic_signature'], anonymization=AnonymizationConfig(fields=['date'], key='caseId'))
...
class HomologousRecombinationDeficiencySchema(ModelGetSchema):
    ...
    config = SchemaConfig(model=orm.HomologousRecombinationDeficiency, exclude=['genomic_signature'], anonymization=AnonymizationConfig(fields=['date'], key='caseId'))
...
class TumorNeoantigenBurdenSchema(ModelGetSchema):
    ...
    config = SchemaConfig(model=orm.TumorNeoantigenBurden, exclude=['genomic_signature'], anonymization=AnonymizationConfig(fields=['date'], key='caseId'))
...
class AneuploidScoreSchema(ModelGetSchema):
    ...
    config = SchemaConfig(model=orm.AneuploidScore, exclude=['genomic_signature'], anonymization=AnonymizationConfig(fields=['date'], key='caseId'))
