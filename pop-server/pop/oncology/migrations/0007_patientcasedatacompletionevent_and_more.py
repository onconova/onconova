    ...
    operations = [
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "oncology_patientcasedatacompletionevent" ("case_id", "category", "external_source", "external_source_id", "id", "pgh_context", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id") VALUES (NEW."case_id", NEW."category", NEW."external_source", NEW."external_source_id", NEW."id", COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_metadata\', TRUE), \'\'), NULL)::JSONB, COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_id\', TRUE), \'\'), NULL)::UUID, NOW(), \'create\', NEW."id"); RETURN NULL;',
                    hash="a60591764dd3b9d331baf30f28c4a4c30a9f65ec",
                    operation="INSERT",
                    pgid="pgtrigger_create_insert_abc44",
                    table="oncology_patientcasedatacompletion",
                    when="AFTER",
                ),
            ),
        ),
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash="31298120fbd7a6e86d3058633819061d701341ca",
                    operation="UPDATE",
                    pgid="pgtrigger_update_update_acc3b",
                    table="oncology_patientcasedatacompletion",
                    when="AFTER",
                ),
            ),
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                name="delete_delete",
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "oncology_patientcasedatacompletionevent" ("case_id", "category", "external_source", "external_source_id", "id", "pgh_context", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id") VALUES (OLD."case_id", OLD."category", OLD."external_source", OLD."external_source_id", OLD."id", COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_metadata\', TRUE), \'\'), NULL)::JSONB, COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_id\', TRUE), \'\'), NULL)::UUID, NOW(), \'delete\', OLD."id"); RETURN NULL;',
                    hash="d47ad25cdc28d3d0f3d23653fbd1409a2a62edd1",
                    operation="DELETE",
                    pgid="pgtrigger_delete_delete_805aa",
                    table="oncology_patientcasedatacompletion",
                    when="AFTER",
                ),
            ),
