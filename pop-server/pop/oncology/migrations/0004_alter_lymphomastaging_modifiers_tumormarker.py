    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mass_concentration', pop.core.measures.fields.MeasurementField(blank=True, help_text='Mass concentration of the analyte (if revelant/measured)', measurement=pop.core.measures.MassConcentration, null=True, verbose_name='Mass concentration')),
                ('arbitrary_concentration', pop.core.measures.fields.MeasurementField(blank=True, help_text='Arbitrary concentration of the analyte (if revelant/measured)', measurement=pop.core.measures.ArbitraryConcentration, null=True, verbose_name='Arbitrary concentration')),
                ('substance_concentration', pop.core.measures.fields.MeasurementField(blank=True, help_text='Substance concentration of the analyte (if revelant/measured)', measurement=pop.core.measures.SubstanceConcentration, null=True, verbose_name='Substance concentration')),
                ('fraction', pop.core.measures.fields.MeasurementField(blank=True, help_text='Analyte fraction (if revelant/measured)', measurement=pop.core.measures.Fraction, null=True, verbose_name='Fraction')),
                ('multiple_of_median', pop.core.measures.fields.MeasurementField(blank=True, help_text='Multiples of the median analyte (if revelant/measured)', measurement=pop.core.measures.MultipleOfMedian, null=True, verbose_name='Multiples of the median')),
