...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='lifestyle',
            name='night_sleep',
            field=pop.core.fields.MeasurementField(blank=True, help_text='Estimated average sleep time per night', measurement=pop.core.measures.Time, null=True, verbose_name='Night sleep'),
        ),
        migrations.AlterField(
            model_name='lifestyle',
            name='smoking_quited',
            field=pop.core.fields.MeasurementField(blank=True, help_text='Estimated time since quitting smoking (if applicable)', measurement=pop.core.measures.Time, null=True, verbose_name='Time since quitted smoking'),
        ),
