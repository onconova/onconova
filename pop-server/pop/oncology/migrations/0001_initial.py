    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('smoking_status', models.ForeignKey(blank=True, help_text='Frequency of alcohol consumption', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='terminology.smokingstatus', verbose_name='Alcohol consumption')),
                ('updated_by', models.ManyToManyField(help_text='The user(s) who updated the data since its creation', related_name='+', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modifiers', models.ManyToManyField(help_text='Qualifier acting as modifier for the lymphoma stage', related_name='+', to='terminology.lymphomastagevaluemodifier', verbose_name='Lymphoma stage modifier')),
