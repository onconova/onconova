...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('oncology', '0005_remove_genomicvariant_valid_genomic_hgvs_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pgh_context', pghistory.utils.JSONField(null=True)),
                ('pgh_context_id', models.UUIDField(null=True)),
                ('genomic_signature', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, parent_link=True, related_name='+', related_query_name='+', serialize=False, to='oncology.genomicsignature')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pgh_context', pghistory.utils.JSONField(null=True)),
                ('pgh_context_id', models.UUIDField(null=True)),
                ('staging', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, parent_link=True, related_name='+', related_query_name='+', serialize=False, to='oncology.staging')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('smoking_quited', pop.core.measures.fields.MeasurementField(blank=True, help_text='Estimated time since quitting smoking (if applicable)', measurement=pop.core.measures.measures.Time, null=True, verbose_name='Time since quitted smoking')),
                ('night_sleep', pop.core.measures.fields.MeasurementField(blank=True, help_text='Estimated average sleep time per night', measurement=pop.core.measures.measures.Time, null=True, verbose_name='Night sleep')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pgh_context', pghistory.utils.JSONField(null=True)),
                ('pgh_context_id', models.UUIDField(null=True)),
                ('tumor_board', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, parent_link=True, related_name='+', related_query_name='+', serialize=False, to='oncology.tumorboard')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('external_source', models.CharField(blank=True, help_text='The digital source of the data, relevant for automated data', null=True, verbose_name='External data source')),
                ('external_source_id', models.CharField(blank=True, help_text='The data identifier at the digital source of the data, relevant for automated data', null=True, verbose_name='External data source Id')),
                ('pseudoidentifier', models.CharField(editable=False, help_text='Pseudoidentifier of the patient', max_length=40, verbose_name='Pseudoidentifier')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dose', pop.core.measures.fields.MeasurementField(blank=True, help_text='Total radiation dose delivered over the full radiotherapy course', measurement=pop.core.measures.measures.RadiationDose, null=True, verbose_name='Total radiation dose')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dosage_mass_concentration', pop.core.measures.fields.MeasurementField(blank=True, help_text='Dosage of the medication expressed in mass concentration (if revelant/appliccable)', measurement=pop.core.measures.measures.MassConcentration, null=True, verbose_name='Dosage - Mass concentration')),
                ('dosage_mass', pop.core.measures.fields.MeasurementField(blank=True, help_text='Dosage of the medication expressed in a fixed mass (if revelant/appliccable)', measurement=measurement.measures.mass.Mass, null=True, verbose_name='Dosage - Fixed Mass')),
                ('dosage_volume', pop.core.measures.fields.MeasurementField(blank=True, help_text='Dosage of the medication expressed in a volume (if revelant/appliccable)', measurement=pop.core.measures.measures.Volume, null=True, verbose_name='Dosage - Volume')),
                ('dosage_mass_surface', pop.core.measures.fields.MeasurementField(blank=True, help_text='Dosage of the medication expressed in a mass per body surface area (if revelant/appliccable)', measurement=pop.core.measures.measures.MassPerArea, null=True, verbose_name='Dosage - Mass per body surface')),
                ('dosage_rate_mass_concentration', pop.core.measures.fields.MeasurementField(blank=True, help_text='Dosage rate of the medication expressed in mass concentration (if revelant/appliccable)', measurement=pop.core.measures.measures.MassConcentrationPerTime, null=True, verbose_name='Dosage rate - Mass concentration')),
                ('dosage_rate_mass', pop.core.measures.fields.MeasurementField(blank=True, help_text='Dosage rate of the medication expressed in a fixed mass (if revelant/appliccable)', measurement=pop.core.measures.measures.MassPerTime, null=True, verbose_name='Dosage rate - Fixed Mass')),
                ('dosage_rate_volume', pop.core.measures.fields.MeasurementField(blank=True, help_text='Dosage rate of the medication expressed in a volume (if revelant/appliccable)', measurement=pop.core.measures.measures.VolumePerTime, null=True, verbose_name='Dosage rate - Volume')),
                ('dosage_rate_mass_surface', pop.core.measures.fields.MeasurementField(blank=True, help_text='Dosage rate of the medication expressed in a mass per body surface area (if revelant/appliccable)', measurement=pop.core.measures.measures.MassPerAreaPerTime, null=True, verbose_name='Dosage rate - Mass per body surface')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mass_concentration', pop.core.measures.fields.MeasurementField(blank=True, help_text='Mass concentration of the analyte (if revelant/measured)', measurement=pop.core.measures.measures.MassConcentration, null=True, verbose_name='Mass concentration')),
                ('arbitrary_concentration', pop.core.measures.fields.MeasurementField(blank=True, help_text='Arbitrary concentration of the analyte (if revelant/measured)', measurement=pop.core.measures.measures.ArbitraryConcentration, null=True, verbose_name='Arbitrary concentration')),
                ('substance_concentration', pop.core.measures.fields.MeasurementField(blank=True, help_text='Substance concentration of the analyte (if revelant/measured)', measurement=pop.core.measures.measures.SubstanceConcentration, null=True, verbose_name='Substance concentration')),
                ('fraction', pop.core.measures.fields.MeasurementField(blank=True, help_text='Analyte fraction (if revelant/measured)', measurement=pop.core.measures.measures.Fraction, null=True, verbose_name='Fraction')),
                ('multiple_of_median', pop.core.measures.fields.MeasurementField(blank=True, help_text='Multiples of the median analyte (if revelant/measured)', measurement=pop.core.measures.measures.MultipleOfMedian, null=True, verbose_name='Multiples of the median')),
                ...
                ('combined_positive_score', pop.core.measures.fields.MeasurementField(blank=True, help_text='The number of PD-L1 positive cells, including tumor cells, lymphocytes, and macrophages divided by the total number of viable tumor cells multiplied by 100', measurement=pop.core.measures.measures.Fraction, null=True, verbose_name='Combined Positive Score (CPS)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body_mass_index', models.GeneratedField(db_persist=True, expression=django.db.models.expressions.CombinedExpression(models.F('weight'), '/', django.db.models.expressions.CombinedExpression(models.F('height'), '*', models.F('height'))), help_text='Bodymass index of the patient', output_field=pop.core.measures.fields.MeasurementField(measurement=pop.core.measures.measures.MassPerArea), verbose_name='Bodymass')),
                ('blood_pressure_systolic', pop.core.measures.fields.MeasurementField(blank=True, help_text='Systolic blood pressure of the patient', measurement=pop.core.measures.measures.Pressure, null=True, verbose_name='Systolic blood pressure')),
                ('blood_pressure_diastolic', pop.core.measures.fields.MeasurementField(blank=True, help_text='Diastolic blood pressure of the patient', measurement=pop.core.measures.measures.Pressure, null=True, verbose_name='Diastolic blood pressure')),
                ('temperature', pop.core.measures.fields.MeasurementField(blank=True, help_text='Temperature of the patient', measurement=pop.core.measures.measures.Temperature, null=True, verbose_name='Temperature')),
            ],
            options={
                'abstract': False,
            },
        ...
        pgtrigger.migrations.AddTrigger(
            model_name='genomicvariant',
            trigger=pgtrigger.compiler.Trigger(name='create_insert', sql=pgtrigger.compiler.UpsertTriggerSql(func='INSERT INTO "oncology_genomicvariantevent" ("allele_depth", "allele_frequency", "analysis_method_id", "assessment", "case_id", "clinical_relevance", "clinvar", "confidence", "coordinate_system_id", "copy_number", "date", "dna_hgvs", "external_source", "external_source_id", "gene_panel", "genome_assembly_version_id", "id", "inheritance_id", "molecular_consequence_id", "pgh_context", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "protein_hgvs", "rna_hgvs", "zygosity_id") VALUES (NEW."allele_depth", NEW."allele_frequency", NEW."analysis_method_id", NEW."assessment", NEW."case_id", NEW."clinical_relevance", NEW."clinvar", NEW."confidence", NEW."coordinate_system_id", NEW."copy_number", NEW."date", NEW."dna_hgvs", NEW."external_source", NEW."external_source_id", NEW."gene_panel", NEW."genome_assembly_version_id", NEW."id", NEW."inheritance_id", NEW."molecular_consequence_id", COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_metadata\', TRUE), \'\'), NULL)::JSONB, COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_id\', TRUE), \'\'), NULL)::UUID, NOW(), \'create\', NEW."id", NEW."protein_hgvs", NEW."rna_hgvs", NEW."zygosity_id"); RETURN NULL;', hash='6e381914eab9d071e5ed94aef9d4440b0646211d', operation='INSERT', pgid='pgtrigger_create_insert_9a498', table='oncology_genomicvariant', when='AFTER')),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='genomicvariant',
            trigger=pgtrigger.compiler.Trigger(name='update_update', sql=pgtrigger.compiler.UpsertTriggerSql(condition='WHEN (OLD.* IS DISTINCT FROM NEW.*)', func='INSERT INTO "oncology_genomicvariantevent" ("allele_depth", "allele_frequency", "analysis_method_id", "assessment", "case_id", "clinical_relevance", "clinvar", "confidence", "coordinate_system_id", "copy_number", "date", "dna_hgvs", "external_source", "external_source_id", "gene_panel", "genome_assembly_version_id", "id", "inheritance_id", "molecular_consequence_id", "pgh_context", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "protein_hgvs", "rna_hgvs", "zygosity_id") VALUES (NEW."allele_depth", NEW."allele_frequency", NEW."analysis_method_id", NEW."assessment", NEW."case_id", NEW."clinical_relevance", NEW."clinvar", NEW."confidence", NEW."coordinate_system_id", NEW."copy_number", NEW."date", NEW."dna_hgvs", NEW."external_source", NEW."external_source_id", NEW."gene_panel", NEW."genome_assembly_version_id", NEW."id", NEW."inheritance_id", NEW."molecular_consequence_id", COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_metadata\', TRUE), \'\'), NULL)::JSONB, COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_id\', TRUE), \'\'), NULL)::UUID, NOW(), \'update\', NEW."id", NEW."protein_hgvs", NEW."rna_hgvs", NEW."zygosity_id"); RETURN NULL;', hash='6757535e12ef4ab8ac9c6bcf7236aa38b35f2474', operation='UPDATE', pgid='pgtrigger_update_update_5a801', table='oncology_genomicvariant', when='AFTER')),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='genomicvariant',
            trigger=pgtrigger.compiler.Trigger(name='delete_delete', sql=pgtrigger.compiler.UpsertTriggerSql(func='INSERT INTO "oncology_genomicvariantevent" ("allele_depth", "allele_frequency", "analysis_method_id", "assessment", "case_id", "clinical_relevance", "clinvar", "confidence", "coordinate_system_id", "copy_number", "date", "dna_hgvs", "external_source", "external_source_id", "gene_panel", "genome_assembly_version_id", "id", "inheritance_id", "molecular_consequence_id", "pgh_context", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "protein_hgvs", "rna_hgvs", "zygosity_id") VALUES (OLD."allele_depth", OLD."allele_frequency", OLD."analysis_method_id", OLD."assessment", OLD."case_id", OLD."clinical_relevance", OLD."clinvar", OLD."confidence", OLD."coordinate_system_id", OLD."copy_number", OLD."date", OLD."dna_hgvs", OLD."external_source", OLD."external_source_id", OLD."gene_panel", OLD."genome_assembly_version_id", OLD."id", OLD."inheritance_id", OLD."molecular_consequence_id", COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_metadata\', TRUE), \'\'), NULL)::JSONB, COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_id\', TRUE), \'\'), NULL)::UUID, NOW(), \'delete\', OLD."id", OLD."protein_hgvs", OLD."rna_hgvs", OLD."zygosity_id"); RETURN NULL;', hash='261fa6dfe3605eaf8feaf88253efbfda608a8ebc', operation='DELETE', pgid='pgtrigger_delete_delete_43385', table='oncology_genomicvariant', when='AFTER')),
        ),
        pgtrigger.migrations.AddTrigger(
        ...
        pgtrigger.migrations.AddTrigger(
            model_name='patientcase',
            trigger=pgtrigger.compiler.Trigger(name='create_insert', sql=pgtrigger.compiler.UpsertTriggerSql(func='INSERT INTO "oncology_patientcaseevent" ("cause_of_death_id", "clinical_center", "clinical_identifier", "consent_status", "date_of_birth", "date_of_death", "external_source", "external_source_id", "gender_id", "gender_identity_id", "id", "pgh_context", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "pseudoidentifier", "race_id", "sex_at_birth_id") VALUES (NEW."cause_of_death_id", NEW."clinical_center", NEW."clinical_identifier", NEW."consent_status", NEW."date_of_birth", NEW."date_of_death", NEW."external_source", NEW."external_source_id", NEW."gender_id", NEW."gender_identity_id", NEW."id", COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_metadata\', TRUE), \'\'), NULL)::JSONB, COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_id\', TRUE), \'\'), NULL)::UUID, NOW(), \'create\', NEW."id", NEW."pseudoidentifier", NEW."race_id", NEW."sex_at_birth_id"); RETURN NULL;', hash='46063b3b9cdc4c7b64a056544860e4b793796a3b', operation='INSERT', pgid='pgtrigger_create_insert_8b48e', table='oncology_patientcase', when='AFTER')),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='patientcase',
            trigger=pgtrigger.compiler.Trigger(name='update_update', sql=pgtrigger.compiler.UpsertTriggerSql(condition='WHEN (OLD.* IS DISTINCT FROM NEW.*)', func='INSERT INTO "oncology_patientcaseevent" ("cause_of_death_id", "clinical_center", "clinical_identifier", "consent_status", "date_of_birth", "date_of_death", "external_source", "external_source_id", "gender_id", "gender_identity_id", "id", "pgh_context", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "pseudoidentifier", "race_id", "sex_at_birth_id") VALUES (NEW."cause_of_death_id", NEW."clinical_center", NEW."clinical_identifier", NEW."consent_status", NEW."date_of_birth", NEW."date_of_death", NEW."external_source", NEW."external_source_id", NEW."gender_id", NEW."gender_identity_id", NEW."id", COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_metadata\', TRUE), \'\'), NULL)::JSONB, COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_id\', TRUE), \'\'), NULL)::UUID, NOW(), \'update\', NEW."id", NEW."pseudoidentifier", NEW."race_id", NEW."sex_at_birth_id"); RETURN NULL;', hash='d864edeb3341e30251008bf1b2962e8c91a2a842', operation='UPDATE', pgid='pgtrigger_update_update_66852', table='oncology_patientcase', when='AFTER')),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='patientcase',
            trigger=pgtrigger.compiler.Trigger(name='delete_delete', sql=pgtrigger.compiler.UpsertTriggerSql(func='INSERT INTO "oncology_patientcaseevent" ("cause_of_death_id", "clinical_center", "clinical_identifier", "consent_status", "date_of_birth", "date_of_death", "external_source", "external_source_id", "gender_id", "gender_identity_id", "id", "pgh_context", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "pseudoidentifier", "race_id", "sex_at_birth_id") VALUES (OLD."cause_of_death_id", OLD."clinical_center", OLD."clinical_identifier", OLD."consent_status", OLD."date_of_birth", OLD."date_of_death", OLD."external_source", OLD."external_source_id", OLD."gender_id", OLD."gender_identity_id", OLD."id", COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_metadata\', TRUE), \'\'), NULL)::JSONB, COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_id\', TRUE), \'\'), NULL)::UUID, NOW(), \'delete\', OLD."id", OLD."pseudoidentifier", OLD."race_id", OLD."sex_at_birth_id"); RETURN NULL;', hash='6cfa8e5d579548cf2e2dbce6ba1b3bd648e39cc5', operation='DELETE', pgid='pgtrigger_delete_delete_5505c', table='oncology_patientcase', when='AFTER')),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='performancestatus',
        ...
        migrations.AddField(
            ...
            name='case',
            field=models.ForeignKey(db_constraint=False, help_text='Indicates the case of the patient who had the adverse event being recorded', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.patientcase', verbose_name='Patient case'),
        ),
        migrations.AddField(
            model_name='adverseeventevent',
            name='event',
            field=models.ForeignKey(db_constraint=False, help_text='Classification of the adverse event using CTCAE criteria', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.adverseeventterm', verbose_name='Adverse event'),
        ),
        migrations.AddField(
            model_name='adverseeventevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.adverseevent'),
        ),
        migrations.AddField(
            model_name='adverseeventevent',
            name='is_resolved',
        ...
        migrations.AddField(
            ...
            name='adjustment',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Classification of the adjustment of systemic anti-cancer treatment used to mitigate the adverse event (if applicable)', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.adverseeventmitigationtreatmentadjustment', verbose_name='Treatment Adjustment'),
        ),
        migrations.AddField(
            model_name='adverseeventmitigationevent',
            name='adverse_event',
            field=models.ForeignKey(db_constraint=False, help_text='Adverse event to which this mitigation belongs to', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.adverseevent', verbose_name='Adverse event'),
        ),
        migrations.AddField(
            model_name='adverseeventmitigationevent',
            name='drug',
        ...
        migrations.AddField(
            model_name='adverseeventmitigationevent',
            name='management',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Management type of the adverse event mitigation', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.adverseeventmitigationmanagement', verbose_name='Management'),
        ),
        migrations.AddField(
            model_name='adverseeventmitigationevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.adverseeventmitigation'),
        ),
        migrations.AddField(
            model_name='adverseeventmitigationevent',
            name='procedure',
        ...
        migrations.AddField(
            ...
            name='adverse_event',
            field=models.ForeignKey(db_constraint=False, help_text='Adverse event to which this suspected cause belongs to', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.adverseevent', verbose_name='Adverse event'),
        ),
        migrations.AddField(
            model_name='adverseeventsuspectedcauseevent',
            name='medication',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Systemic therapy medication suspected to be the cause of the adverse event', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.systemictherapymedication', verbose_name='Suspected systemic therapy medication'),
        ),
        migrations.AddField(
            model_name='adverseeventsuspectedcauseevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.adverseeventsuspectedcause'),
        ),
        migrations.AddField(
            model_name='adverseeventsuspectedcauseevent',
            name='radiotherapy',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Radiotherapy suspected to be the cause of the adverse event', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.radiotherapy', verbose_name='Suspected radiotherapy'),
        ),
        migrations.AddField(
            model_name='adverseeventsuspectedcauseevent',
            name='surgery',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Surgery suspected to be the cause of the adverse event', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.surgery', verbose_name='Suspected surgery'),
        ),
        migrations.AddField(
            model_name='adverseeventsuspectedcauseevent',
            name='systemic_therapy',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Systemic therapy suspected to be the cause of the adverse event', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.systemictherapy', verbose_name='Suspected systemic therapy'),
        ),
        migrations.AddField(
            model_name='aneuploidscoreevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.aneuploidscore'),
        ),
        migrations.AddField(
            model_name='binetstagingevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.binetstaging'),
        ),
        migrations.AddField(
            model_name='binetstagingevent',
            name='stage',
            field=models.ForeignKey(db_constraint=False, help_text='The value of the Binet stage', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.binetstage', verbose_name='Binet Stage'),
        ),
        migrations.AddField(
            model_name='breslowdepthevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.breslowdepth'),
        ),
        migrations.AddField(
            model_name='clarkstagingevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.clarkstaging'),
        ),
        migrations.AddField(
            model_name='clarkstagingevent',
            name='stage',
            field=models.ForeignKey(db_constraint=False, help_text='The value of the Clark level stage', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.clarklevel', verbose_name='Clark Level Stage'),
        ),
        migrations.AddField(
            model_name='comorbiditiesassessmentevent',
            name='case',
            field=models.ForeignKey(db_constraint=False, help_text="Indicates the case of the patient who's comorbidities are being recorded", on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.patientcase', verbose_name='Patient case'),
        ),
        migrations.AddField(
            model_name='comorbiditiesassessmentevent',
            name='index_condition',
            field=models.ForeignKey(db_constraint=False, help_text='The primary neoplastic entity against which comorbidities are assessed', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.neoplasticentity', verbose_name='Index neoplastic entity'),
        ),
        migrations.AddField(
            model_name='comorbiditiesassessmentevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.comorbiditiesassessment'),
        ),
        migrations.AddField(
            model_name='familyhistoryevent',
            name='case',
            field=models.ForeignKey(db_constraint=False, help_text="Indicates the case of the patient who's family's history is being recorded", on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.patientcase', verbose_name='Patient case'),
        ),
        migrations.AddField(
            model_name='familyhistoryevent',
            name='morphology',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text="Morphology of the family member's cancer (if known)", null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.cancermorphology', verbose_name='Morphology'),
        ),
        migrations.AddField(
            model_name='familyhistoryevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.familyhistory'),
        ),
        migrations.AddField(
            model_name='familyhistoryevent',
            name='relationship',
            field=models.ForeignKey(db_constraint=False, help_text='Relationship to the patient', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.familymembertype', verbose_name='Relationship'),
        ),
        migrations.AddField(
            model_name='familyhistoryevent',
            name='topography',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text="Estimated or actual topography of the family member's cancer", null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.cancertopography', verbose_name='Topography'),
        ),
        migrations.AddField(
            model_name='figostagingevent',
            name='methodology',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Methodology used for the FIGO staging', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.figostagingmethod', verbose_name='FIGO staging methodology'),
        ),
        migrations.AddField(
            model_name='figostagingevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.figostaging'),
        ),
        migrations.AddField(
            model_name='figostagingevent',
            name='stage',
            field=models.ForeignKey(db_constraint=False, help_text='The value of the FIGO stage', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.figostage', verbose_name='FIGO Stage'),
        ),
        migrations.AddField(
            model_name='genomicsignatureevent',
            name='case',
            field=models.ForeignKey(db_constraint=False, help_text="Indicates the case of the patient who's lifestyle is assesed", on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.patientcase', verbose_name='Patient case'),
        ),
        migrations.AddField(
            model_name='genomicsignatureevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='parent_events', related_query_name='parent_events', to='oncology.genomicsignature'),
        ),
        migrations.AddField(
            model_name='genomicvariantevent',
            name='analysis_method',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Analysis method used to detect the variant', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.structuralvariantanalysismethod', verbose_name='Analysis method'),
        ),
        migrations.AddField(
            model_name='genomicvariantevent',
            name='case',
            field=models.ForeignKey(db_constraint=False, help_text="Indicates the case of the patient who' genomic variant is described", on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.patientcase', verbose_name='Patient case'),
        ),
        migrations.AddField(
            model_name='genomicvariantevent',
            name='coordinate_system',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Genomic coordinate system used for identifying nucleotides or amino acids within a sequence.', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.genomiccoordinatesystem', verbose_name='Coordinate system'),
        ),
        migrations.AddField(
            model_name='genomicvariantevent',
            name='genome_assembly_version',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='The reference genome assembly versionused in this analysis.', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.referencegenomebuild', verbose_name='Genome assembly version'),
        ),
        migrations.AddField(
            model_name='genomicvariantevent',
            name='inheritance',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Variant inheritance origin (if known).', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.variantinheritance', verbose_name='Inheritance'),
        ),
        migrations.AddField(
            model_name='genomicvariantevent',
            name='molecular_consequence',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='The calculated or observed effect of a variant on its downstream transcript and, if applicable, ensuing protein sequence.', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.molecularconsequence', verbose_name='Molecular consequence'),
        ),
        migrations.AddField(
            model_name='genomicvariantevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.genomicvariant'),
        ),
        migrations.AddField(
            model_name='genomicvariantevent',
            name='zygosity',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='The observed level of occurrence of the variant in the set of chromosomes.', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.zygosity', verbose_name='Zygosity'),
        ),
        migrations.AddField(
            model_name='genomicvariantevent',
            name='is_vus',
            field=models.GeneratedField(db_persist=True, expression=models.Case(models.When(models.Q(('clinical_relevance__isnull', True)), then=models.Value(None)), models.When(models.Q(('clinical_relevance', 'uncertain_significance')), then=models.Value(True)), default=models.Value(False), output_field=models.BooleanField()), help_text='Indicates if the variant is of unknown signfiance (determined automatically based on the clinical relevance classification)', null=True, output_field=models.BooleanField(), verbose_name='Is pathogenic'),               
        ),
        migrations.AddField(
            model_name='genomicvariantevent',
            name='is_pathogenic',
        ...
        migrations.AddField(
            ...
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.gleasongrade'),
        ),
        migrations.AddField(
            model_name='gleasongradeevent',
            name='stage',
            field=models.ForeignKey(db_constraint=False, help_text='The value of the Gleason grade stage', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.gleasongradegroupstage', verbose_name='Gleason grade Stage'),
        ),
        migrations.AddField(
            model_name='homologousrecombinationdeficiencyevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.homologousrecombinationdeficiency'),
        ),
        migrations.AddField(
            model_name='inrgssstageevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.inrgssstage'),
        ),
        migrations.AddField(
            model_name='inrgssstageevent',
            name='stage',
            field=models.ForeignKey(db_constraint=False, help_text='The value of the INRGSS stage', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.neuroblastomainrgssstage', verbose_name='INRGSS Stage'),
        ),
        migrations.AddField(
            model_name='inssstageevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.inssstage'),
        ),
        migrations.AddField(
            model_name='inssstageevent',
            name='stage',
            field=models.ForeignKey(db_constraint=False, help_text='The value of the INSS stage', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.neuroblastomainssstage', verbose_name='INSS Stage'),
        ),
        migrations.AddField(
            model_name='issstagingevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.issstaging'),
        ),
        migrations.AddField(
            model_name='issstagingevent',
            name='stage',
            field=models.ForeignKey(db_constraint=False, help_text='The value of theISS stage', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.myelomaissstage', verbose_name='ISS Stage'),
        ),
        migrations.AddField(
            model_name='lifestyleevent',
            name='alcohol_consumption',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Frequency of alcohol consumption', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.alcoholconsumptionfrequency', verbose_name='Alcohol consumption'),
        ),
        migrations.AddField(
            model_name='lifestyleevent',
            name='case',
        ...
        migrations.AddField(
            model_name='lifestyleevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.lifestyle'),
        ),
        migrations.AddField(
            model_name='lifestyleevent',
            name='smoking_status',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Frequency of alcohol consumption', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.smokingstatus', verbose_name='Alcohol consumption'),
        ),
        migrations.AddField(
            model_name='lossofheterozygosityevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.lossofheterozygosity'),
        ),
        migrations.AddField(
            model_name='lymphomastagingevent',
            name='methodology',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Methodology used for the Lymphoma staging', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.lymphomastagingmethod', verbose_name='Lymphoma staging methodology'),
        ),
        migrations.AddField(
            model_name='lymphomastagingevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.lymphomastaging'),
        ),
        migrations.AddField(
            model_name='lymphomastagingevent',
            name='stage',
            field=models.ForeignKey(db_constraint=False, help_text='The value of the Lymphoma stage', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.lymphomastage', verbose_name='Lymphoma Stage'),
        ),
        migrations.AddField(
            model_name='microsatelliteinstabilityevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.microsatelliteinstability'),
        ),
        migrations.AddField(
            model_name='microsatelliteinstabilityevent',
            name='value',
            field=models.ForeignKey(db_constraint=False, help_text='Microsatellite instability (MSI) classification', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.microsatelliteinstabilitystate', verbose_name='Value'),
        ),
        migrations.AddField(
            model_name='moleculartherapeuticrecommendationevent',
            name='expected_effect',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Classification of the expected effect of the drug', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.expecteddrugaction', verbose_name='Expected medication action'),
        ),
        migrations.AddField(
            model_name='moleculartherapeuticrecommendationevent',
            name='molecular_tumor_board',
            field=models.ForeignKey(db_constraint=False, help_text='Molecular tumor board where the recommendation was issued', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.moleculartumorboard', verbose_name='Molecular tumor board'),
        ),
        migrations.AddField(
            model_name='moleculartherapeuticrecommendationevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.moleculartherapeuticrecommendation'),
        ),
        migrations.AddField(
            model_name='moleculartumorboardevent',
            name='molecular_comparison_match',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='The neoplastic entity that was matched during the molecular comparison', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.neoplasticentity', verbose_name='Molecular comparison match'),
        ),
        migrations.AddField(
            model_name='moleculartumorboardevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.moleculartumorboard'),
        ),
        migrations.AddField(
            model_name='neoplasticentityevent',
            name='case',
            field=models.ForeignKey(db_constraint=False, help_text="Indicates the case of the patient who's neoplasm(s) are recorded", on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.patientcase', verbose_name='Patient case'),
        ),
        migrations.AddField(
            model_name='neoplasticentityevent',
            name='differentitation',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Morphologic differentitation characteristics of the neoplasm(s)', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.histologydifferentiation', verbose_name='Differentiation'),
        ),
        migrations.AddField(
            model_name='neoplasticentityevent',
            name='laterality',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Laterality qualifier for the location of the neoplasm(s)', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.lateralityqualifier', verbose_name='Laterality'),
        ),
        migrations.AddField(
            model_name='neoplasticentityevent',
            name='morphology',
            field=models.ForeignKey(db_constraint=False, help_text='Describes the cell type of the tumor and its biologic activity, in other words, the characteristics of the tumor itself', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.cancermorphology', verbose_name='Morphology'),
        ),
        migrations.AddField(
            model_name='neoplasticentityevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.neoplasticentity'),
        ),
        migrations.AddField(
            model_name='neoplasticentityevent',
            name='related_primary',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Reference to the primary neoplasm of which the neoplasm(s) originated from.', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.neoplasticentity', verbose_name='Related primary neoplasm'),
        ),
        migrations.AddField(
            model_name='neoplasticentityevent',
            name='topography',
            field=models.ForeignKey(db_constraint=False, help_text='Anatomical location of the neoplasm(s)', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.cancertopography', verbose_name='Topography'),
        ),
        migrations.AddField(
            model_name='patientcaseevent',
            name='cause_of_death',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Classification of the cause of death.', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.causeofdeath', verbose_name='Cause of death'),
        ),
        migrations.AddField(
            model_name='patientcaseevent',
            name='gender',
            field=models.ForeignKey(db_constraint=False, help_text='Gender for administrative purposes', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.administrativegender', verbose_name='Gender'),
        ),
        migrations.AddField(
            model_name='patientcaseevent',
            name='gender_identity',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.genderidentity', verbose_name='Gender identity'),
        ),
        migrations.AddField(
            model_name='patientcaseevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.patientcase'),
        ),
        migrations.AddField(
            model_name='patientcaseevent',
            name='race',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Race of the patient', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.race', verbose_name='Race'),
        ),
        migrations.AddField(
            model_name='patientcaseevent',
            name='sex_at_birth',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Sex assigned at birth', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.birthsex', verbose_name='Birth sex'),
        ),
        migrations.AddField(
            model_name='patientcaseevent',
            name='is_deceased',
        ...
        migrations.AddField(
            ...
            name='case',
            field=models.ForeignKey(db_constraint=False, help_text="Indicates the case of the patient who's performance status is assesed", on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.patientcase', verbose_name='Patient case'),
        ),
        migrations.AddField(
            model_name='performancestatusevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.performancestatus'),
        ),
        migrations.AddField(
            model_name='radiotherapydosageevent',
            name='irradiated_volume',
            field=models.ForeignKey(db_constraint=False, help_text='Anatomical location of the irradiated volume', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.radiotherapytreatmentlocation', verbose_name='Irradiated volume'),
        ),
        migrations.AddField(
            model_name='radiotherapydosageevent',
            name='irradiated_volume_morphology',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Morphology of the anatomical location of the irradiated volume', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.radiotherapyvolumetype', verbose_name='Irradiated volume morphology'),
        ),
        migrations.AddField(
            model_name='radiotherapydosageevent',
            name='irradiated_volume_qualifier',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='General qualifier for the anatomical location of the irradiated volume', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.radiotherapytreatmentlocationqualifier', verbose_name='Irradiated volume qualifier'),
        ),
        migrations.AddField(
            model_name='radiotherapydosageevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.radiotherapydosage'),
        ),
        migrations.AddField(
            model_name='radiotherapydosageevent',
            name='radiotherapy',
            field=models.ForeignKey(db_constraint=False, help_text='Indicates the radoptherapy where this dosage was delivered', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.radiotherapy', verbose_name='Radiotherapy'),
        ),
        migrations.AddField(
            model_name='radiotherapyevent',
            name='case',
            field=models.ForeignKey(db_constraint=False, help_text='Indicates the case of the patient who received the radiotherapy', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.patientcase', verbose_name='Patient case'),
        ),
        migrations.AddField(
            model_name='radiotherapyevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.radiotherapy'),
        ),
        migrations.AddField(
            model_name='radiotherapyevent',
            name='termination_reason',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Explanation for the premature or planned termination of the radiotherapy', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.treatmentterminationreason', verbose_name='Termination reason'),
        ),
        migrations.AddField(
            model_name='radiotherapyevent',
            name='therapy_line',
        ...
        migrations.AddField(
            ...
            name='modality',
            field=models.ForeignKey(db_constraint=False, help_text='Modality of external beam or brachytherapy radiation procedures', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.radiotherapymodality', verbose_name='Modality'),
        ),
        migrations.AddField(
            model_name='radiotherapysettingevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.radiotherapysetting'),
        ),
        migrations.AddField(
            model_name='radiotherapysettingevent',
            name='radiotherapy',
        ...
        migrations.AddField(
            model_name='radiotherapysettingevent',
            name='technique',
            field=models.ForeignKey(db_constraint=False, help_text='Technique of external beam or brachytherapy radiation procedures', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.radiotherapytechnique', verbose_name='Technique'),
        ),
        migrations.AddField(
            model_name='raistagingevent',
            name='methodology',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Methodology used for the Rai staging', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.raistagingmethod', verbose_name='Rai staging methodology'),
        ),
        migrations.AddField(
            model_name='raistagingevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.raistaging'),
        ),
        migrations.AddField(
            model_name='raistagingevent',
            name='stage',
            field=models.ForeignKey(db_constraint=False, help_text='The value of the Rai stage', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.raistage', verbose_name='Rai Stage'),
        ),
        migrations.AddField(
            model_name='rhabdomyosarcomaclinicalgroupevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.rhabdomyosarcomaclinicalgroup'),
        ),
        migrations.AddField(
            model_name='rhabdomyosarcomaclinicalgroupevent',
            name='stage',
            field=models.ForeignKey(db_constraint=False, help_text='The value of the rhabdomyosarcoma clinical group', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.rhabdomyosarcomaclinicalgroup', verbose_name='Rhabdomyosarcoma clinical group'),
        ),
        migrations.AddField(
            model_name='riskassessmentevent',
            name='case',
            field=models.ForeignKey(db_constraint=False, help_text="Indicates the case of the patient who's cancer risk is assesed", on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.patientcase', verbose_name='Patient case'),
        ),
        migrations.AddField(
            model_name='riskassessmentevent',
            name='methodology',
            field=models.ForeignKey(db_constraint=False, help_text='Indicates the method or type of risk assessment', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.cancerriskassessmentmethod', verbose_name='Assessment methodology'),
        ),
        migrations.AddField(
            model_name='riskassessmentevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.riskassessment'),
        ),
        migrations.AddField(
            model_name='riskassessmentevent',
            name='risk',
            field=models.ForeignKey(db_constraint=False, help_text='Assessed risk', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.cancerriskassessmentclassification', verbose_name='Risk'),
        ),
        migrations.AddField(
            model_name='rissstagingevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.rissstaging'),
        ),
        migrations.AddField(
            model_name='rissstagingevent',
            name='stage',
            field=models.ForeignKey(db_constraint=False, help_text='The value of the RISS stage', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.myelomarissstage', verbose_name='RISS Stage'),
        ),
        migrations.AddField(
            model_name='stagingevent',
            name='case',
            field=models.ForeignKey(db_constraint=False, help_text="Indicates the case of the patient who's cancer is staged", on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.patientcase', verbose_name='Patient case'),
        ),
        migrations.AddField(
            model_name='stagingevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='parent_events', related_query_name='parent_events', to='oncology.staging'),
        ),
        migrations.AddField(
            model_name='surgeryevent',
            name='bodysite',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Anatomical location of the surgery', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.cancertopography', verbose_name='Anatomical location'),
        ),
        migrations.AddField(
            model_name='surgeryevent',
            name='bodysite_laterality',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Laterality for the anatomical location of the surgery', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.lateralityqualifier', verbose_name='Anatomical location laterality'),
        ),
        migrations.AddField(
            model_name='surgeryevent',
            name='bodysite_qualifier',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='General qualifier for the anatomical location of the surgery', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.bodylocationqualifier', verbose_name='Anatomical location qualifier'),
        ),
        migrations.AddField(
            model_name='surgeryevent',
            name='case',
            field=models.ForeignKey(db_constraint=False, help_text='Indicates the case of the patient who received the surgical procedure', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.patientcase', verbose_name='Patient case'),
        ),
        migrations.AddField(
            model_name='surgeryevent',
            name='outcome',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='The outcome of the surgery', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.procedureoutcome', verbose_name='Outcome'),
        ),
        migrations.AddField(
            model_name='surgeryevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.surgery'),
        ),
        migrations.AddField(
            model_name='surgeryevent',
            name='procedure',
            field=models.ForeignKey(db_constraint=False, help_text='The specific surgical procedure that was performed', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.surgicalprocedure', verbose_name='Surgical procedure'),
        ),
        migrations.AddField(
            model_name='surgeryevent',
            name='therapy_line',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Indicates the role of the adjunctive therapy (if applicable).', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.adjunctivetherapyrole', verbose_name='Treatment Role'),
        ),
        migrations.AddField(
            model_name='systemictherapyevent',
            name='case',
            field=models.ForeignKey(db_constraint=False, help_text='Indicates the case of the patient who received the systemic therapy', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.patientcase', verbose_name='Patient case'),
        ),
        migrations.AddField(
            model_name='systemictherapyevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.systemictherapy'),
        ),
        migrations.AddField(
            model_name='systemictherapyevent',
            name='termination_reason',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Explanation for the premature or planned termination of the systemic therapy', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.treatmentterminationreason', verbose_name='Termination reason'),
        ),
        migrations.AddField(
            model_name='systemictherapyevent',
            name='therapy_line',
        ...
        migrations.AddField(
            ...
            name='drug',
            field=models.ForeignKey(db_constraint=False, help_text='Antineoplastic drug/medication administered to the patient', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.antineoplasticagent', verbose_name='Antineoplastic Drug'),
        ),
        migrations.AddField(
            model_name='systemictherapymedicationevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.systemictherapymedication'),
        ),
        migrations.AddField(
            model_name='systemictherapymedicationevent',
            name='route',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Drug administration route', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.dosageroute', verbose_name='Route'),
        ),
        migrations.AddField(
            model_name='systemictherapymedicationevent',
            name='systemic_therapy',
            field=models.ForeignKey(db_constraint=False, help_text='The systemic therapy to which this medication belongs to', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.systemictherapy', verbose_name='Systemic therapy'),
        ),
        migrations.AddField(
            model_name='tnmstagingevent',
            name='distantMetastases',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='M stage (presence of distant metastasis)', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.tnmdistantmetastasescategory', verbose_name='M Stage'),
        ),
        migrations.AddField(
            model_name='tnmstagingevent',
            name='grade',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='G stage (grade of the cancer cells)', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.tnmgradecategory', verbose_name='G Stage'),
        ),
        migrations.AddField(
            model_name='tnmstagingevent',
            name='lymphaticInvasion',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='L stage (invasion into lymphatic vessels)', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.tnmlymphaticinvasioncategory', verbose_name='L Stage'),
        ),
        migrations.AddField(
            model_name='tnmstagingevent',
            name='methodology',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Methodology used for TNM staging', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.tnmstagingmethod', verbose_name='TNM Staging methodology'),
        ),
        migrations.AddField(
            model_name='tnmstagingevent',
            name='perineuralInvasion',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='Pn stage (invasion into adjunct nerves)', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.tnmperineuralinvasioncategory', verbose_name='Pn Stage'),
        ),
        migrations.AddField(
            model_name='tnmstagingevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.tnmstaging'),
        ),
        migrations.AddField(
            model_name='tnmstagingevent',
            name='primaryTumor',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='T stage (extent of the primary tumor)', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.tnmprimarytumorcategory', verbose_name='T Stage'),
        ),
        migrations.AddField(
            model_name='tnmstagingevent',
            name='regionalNodes',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='N stage (degree of spread to regional lymph nodes)', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.tnmregionalnodescategory', verbose_name='N Stage'),
        ),
        migrations.AddField(
            model_name='tnmstagingevent',
            name='residualTumor',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='R stage (extent of residual tumor cells after operation)', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.tnmresidualtumorcategory', verbose_name='R Stage'),
        ),
        migrations.AddField(
            model_name='tnmstagingevent',
            name='serumTumorMarkerLevel',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='S stage (serum tumor marker level)', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.tnmserumtumormarkerlevelcategory', verbose_name='S Stage'),
        ),
        migrations.AddField(
            model_name='tnmstagingevent',
            name='stage',
            field=models.ForeignKey(db_constraint=False, help_text='The information determined as a result of making the observation, if the information has a simple value', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.tnmstage', verbose_name='TNM Stage'),
        ),
        migrations.AddField(
            model_name='tnmstagingevent',
            name='venousInvasion',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='V stage (invasion into venous vessels)', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.tnmvenousinvasioncategory', verbose_name='V Stage'),
        ),
        migrations.AddField(
            model_name='treatmentresponseevent',
            name='case',
            field=models.ForeignKey(db_constraint=False, help_text="Indicates the case of the patient who's treatment response is asseessed", on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.patientcase', verbose_name='Patient case'),
        ),
        migrations.AddField(
            model_name='treatmentresponseevent',
            name='methodology',
            field=models.ForeignKey(db_constraint=False, help_text='Method used to assess and classify the treatment response', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.cancertreatmentresponseobservationmethod', verbose_name='Assessment method'),
        ),
        migrations.AddField(
            model_name='treatmentresponseevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.treatmentresponse'),
        ),
        migrations.AddField(
            model_name='treatmentresponseevent',
            name='recist',
            field=models.ForeignKey(db_constraint=False, help_text='The classification of the treatment response according to RECIST', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.cancertreatmentresponse', verbose_name='RECIST'),
        ),
        migrations.AddField(
            model_name='tumorboardevent',
            name='case',
            field=models.ForeignKey(db_constraint=False, help_text='Indicates the case of the patient which was discussed at the tumor board', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.patientcase', verbose_name='Patient case'),
        ),
        migrations.AddField(
            model_name='tumorboardevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='parent_events', related_query_name='parent_events', to='oncology.tumorboard'),
        ),
        migrations.AddField(
            model_name='tumormarkerevent',
            name='analyte',
            field=models.ForeignKey(db_constraint=False, help_text='The chemical or biological substance/agent that is analyzed.', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.tumormarkeranalyte', verbose_name='Analyte'),
        ),
        migrations.AddField(
            model_name='tumormarkerevent',
            name='case',
            field=models.ForeignKey(db_constraint=False, help_text='Indicates the case of the patient related to the tumor marker result', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.patientcase', verbose_name='Patient case'),
        ),
        migrations.AddField(
            model_name='tumormarkerevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.tumormarker'),
        ),
        migrations.AddField(
            model_name='tumormutationalburdenevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.tumormutationalburden'),
        ),
        migrations.AddField(
            model_name='tumorneoantigenburdenevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.tumorneoantigenburden'),
        ),
        migrations.AddField(
            model_name='unspecifiedtumorboardevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.unspecifiedtumorboard'),
        ),
        migrations.AddField(
            model_name='vitalsevent',
            name='case',
            field=models.ForeignKey(db_constraint=False, help_text="Indicates the case of the patient who's vitals are assesed", on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='oncology.patientcase', verbose_name='Patient case'),
        ),
        migrations.AddField(
            model_name='vitalsevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.vitals'),
        ),
        migrations.AddField(
            model_name='wilmsstageevent',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='oncology.wilmsstage'),
        ),
        migrations.AddField(
            model_name='wilmsstageevent',
            name='stage',
            field=models.ForeignKey(db_constraint=False, help_text='The value of the Wilms stage', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='terminology.wilmstumorstage', verbose_name='Wilms Stage'),
        ),
    ]
