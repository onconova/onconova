    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    django.contrib.postgres.fields.ArrayField(
                        ...
                        default=list,
                        help_text="Clinical centers that are part of the project",
                        size=None,
                        verbose_name="Clinical centers",
                    ),
                ),
                (
                    "title",
                ...
                (
                    ...
                    models.CharField(
                        help_text="Ethics approval number of the project",
                        max_length=100,
                        verbose_name="Ethics approval number",
                    ),
                ),
                (
                    "status",
                ...
                (
                    ...
                    models.JSONField(
                        default=dict,
                        help_text="Data constraints of the project",
                        verbose_name="Data constraints",
                    ),
                ),
                (
                    "leader",
                    models.ForeignKey(
                        help_text="User responsible for the project and its members",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateField(
                        auto_now_add=True,
                        help_text="Date when the user joined the project",
                ...
                (
                    "member",
                    models.ForeignKey(
                        help_text="User that is part of a project",
                ...
                (
                    "project",
                    models.ForeignKey(
                        help_text="Project that the user is part of",
                        on_delete=django.db.models.deletion.CASCADE,
                        to="projects.project",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                help_text="Users that are part of the project",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "granted_by",
                    models.ForeignKey(
                        help_text="Project leader that granted the permission",
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="+",
                        to=settings.AUTH_USER_MODEL,
                ...
                (
                    "member",
                    models.ForeignKey(
                        help_text="Manager of the project data",
                        on_delete=django.db.models.deletion.CASCADE,
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    func='INSERT INTO "projects_projectevent" ("clinical_centers", "data_constraints", "ethics_approval_number", "external_source", "external_source_id", "id", "leader_id", "pgh_context", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "status", "summary", "title") VALUES (NEW."clinical_centers", NEW."data_constraints", NEW."ethics_approval_number", NEW."external_source", NEW."external_source_id", NEW."id", NEW."leader_id", COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_metadata\', TRUE), \'\'), NULL)::JSONB, COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_id\', TRUE), \'\'), NULL)::UUID, NOW(), \'update\', NEW."id", NEW."status", NEW."summary", NEW."title"); RETURN NULL;',
                    hash="5c78e63bb55f78b55c914ef633dee40c2d4dc0dc",
                    operation="UPDATE",
                    pgid="pgtrigger_update_update_804c3",
                    table="projects_project",
                    when="AFTER",
                ),
            ),
