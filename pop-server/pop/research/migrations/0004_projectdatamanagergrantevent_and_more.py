    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    django.contrib.postgres.fields.ranges.DateRangeField(
                        help_text="Period of validity", verbose_name="Validity period"
                    ),
                ),
            ],
            options={
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "projects_projectdatamanagergrantevent" ("external_source", "external_source_id", "id", "member_id", "pgh_context", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "project_id", "revoked", "validity_period") VALUES (NEW."external_source", NEW."external_source_id", NEW."id", NEW."member_id", COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_metadata\', TRUE), \'\'), NULL)::JSONB, COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_id\', TRUE), \'\'), NULL)::UUID, NOW(), \'create\', NEW."id", NEW."project_id", NEW."revoked", NEW."validity_period"); RETURN NULL;',
                    hash="cab44465f14bfbe26d77ce75afdfc79bfbbdefec",
                    operation="INSERT",
                    pgid="pgtrigger_create_insert_d145e",
                    table="projects_projectdatamanagergrant",
                    when="AFTER",
                ),
            ),
        ),
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash="17bcec6eb3692316b7006bf31dc0200ef5ec2078",
                    operation="UPDATE",
                    pgid="pgtrigger_update_update_dc0c8",
                    table="projects_projectdatamanagergrant",
                    when="AFTER",
                ),
            ),
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                name="delete_delete",
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "projects_projectdatamanagergrantevent" ("external_source", "external_source_id", "id", "member_id", "pgh_context", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "project_id", "revoked", "validity_period") VALUES (OLD."external_source", OLD."external_source_id", OLD."id", OLD."member_id", COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_metadata\', TRUE), \'\'), NULL)::JSONB, COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_id\', TRUE), \'\'), NULL)::UUID, NOW(), \'delete\', OLD."id", OLD."project_id", OLD."revoked", OLD."validity_period"); RETURN NULL;',
                    hash="ece2bf399acaec7ed51f2737271803117bb56c62",
                    operation="DELETE",
                    pgid="pgtrigger_delete_delete_a1b8a",
                    table="projects_projectdatamanagergrant",
                    when="AFTER",
                ),
            ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.DO_NOTHING,
                related_name="events",
                to="projects.projectdatamanagergrant",
            ),
        ),
        migrations.AddField(
            model_name="projectdatamanagergrantevent",
