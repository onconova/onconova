...
def expand_AntineoplasticAgent_with_NCTPOT_mappings() -> List[DrugCodedConcept]:
    ...
    def _get_NCIT_descendant_codes(codes):
        ...
        for code in codes:
             desdencant_codes.extend([
                 concept['code'] for concept in request_http_get(f'https://api-evsrest.nci.nih.gov/api/v1/concept/ncit/{code}/descendants?fromRecord=0&pageSize=50000&maxLevel=10000')
            ])
    ...
    ncit_antineoplastic_drugs = NCITAntineoplasticAgentsSubsetDigestor().digest().values()
    ...
    categories = {
        therapy_categories.IMMUNOTHERAPY: _get_NCIT_descendant_codes(['C308', 'C20401']), 
        therapy_categories.HORMONE_THERAPY: _get_NCIT_descendant_codes(['C147908', 'C29701']),
        therapy_categories.METABOLIC_THERAPY: _get_NCIT_descendant_codes(['C177430']),
        therapy_categories.ANTIMETASTATIC_THERAPY: _get_NCIT_descendant_codes(['C2196']),
        therapy_categories.TARGETED_THERAPY: _get_NCIT_descendant_codes(['C163758','C1742','C471','C2189','C177298','C129839']),
        therapy_categories.CHEMOTHERAPY: _get_NCIT_descendant_codes(['C186664']),
        therapy_categories.RADIOPHARMACEUTICAL_THERAPY: _get_NCIT_descendant_codes(['C1446']),
    }
