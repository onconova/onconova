...
class AlcoholConsumptionFrequency(CodedConcept):
    canonical_url = 'https://loinc.org/LL2179-1/'
...
class AdministrativeGender(CodedConcept):
    canonical_url = 'http://hl7.org/fhir/ValueSet/administrative-gender'
    description = 'A relationship between two people characterizing their "familial" relationship'


class ProcedureOutcome(CodedConcept):
    canonical_url = 'http://hl7.org/fhir/ValueSet/procedure-outcome'
    description = 'Procedure Outcome code: A selection of relevant SNOMED CT codes.'


class PrimaryCancerDisorder(CodedConcept):
    canonical_url = 'http://hl7.org/fhir/us/mcode/ValueSet/mcode-primary-cancer-disorder-vs'    
    description = 'Types of primary malignant neoplastic disease, coded in SNOMED CT or ICD-10-CM.'


class SecondaryCancerDisorder(CodedConcept):
    canonical_url = 'http://hl7.org/fhir/us/mcode/ValueSet/mcode-secondary-cancer-disorder-vs'    
...
class LateralityQualifier(CodedConcept):
    canonical_url = 'http://hl7.org/fhir/us/mcode/ValueSet/mcode-laterality-qualifier-vs'
    description = 'Qualifiers to specify laterality.'
    def __str__(self):
        return self.display.replace(' (qualifier value)','')


class CancerBodyLocation(CodedConcept):
    canonical_url = 'http://hl7.org/fhir/us/mcode/ValueSet/mcode-cancer-body-location-vs'
    description = 'Codes describing the location(s) of primary or secondary cancer.'


class HistologyMorphologyBehavior(CodedConcept):
    canonical_url = 'http://hl7.org/fhir/us/mcode/ValueSet/mcode-histology-morphology-behavior-vs'
...
class HistologyBehavior(CodedConcept):
    canonical_url = ''
    description = 'Subcodes representing the behavioral characteristics of neoplasms, and cancer cells.'
...
class BodyLocationQualifier(CodedConcept):
    canonical_url = 'http://hl7.org/fhir/us/mcode/ValueSet/mcode-body-location-qualifier-vs'
...
class GenderIdentity(CodedConcept):
    canonical_url =  'https://loinc.org/LL3322-6/'
...
class TreatmentTerminationReason(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-treatment-termination-reason-vs'
...
class CancerDisorder(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-cancer-disorder-vs'
    description = 'A broad cancer-related value set containing both primary and secondary tumor types.'
...
class AdditionalDosageInstruction(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/ValueSet/additional-instruction-codes'
    description = 'Supplemental instruction or warnings to the patient for medication'


class DosageRoute(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/ValueSet/route-codes'
    description = 'A coded concept describing the route or physiological path of administration of a therapeutic agent into or onto the body of a subject.'


class AdministrationMethod(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/ValueSet/administration-method-codes'
    description = 'A coded concept describing the technique by which the medicine is administered.'


class CancerRelatedSurgicalProcedureCode(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-cancer-related-surgical-procedure-vs'
    description = 'Cancer-Related Surgical Procedures'


class RadiotherapyModality(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-radiotherapy-modality-vs'
...
class RadiotherapyTechnique(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-radiotherapy-technique-vs'
...
class RadiotherapyVolumeType(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-radiotherapy-volume-type-vs'
...
class ObservationBodySite(CodedConcept):
    canonical_url =  'https://pop.org/fhir/ValueSets/pop-observation-bodysites'
    description = 'Bodysites related to an observation.'


class RadiotherapyTreatmentLocation(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-radiotherapy-treatment-location-vs'
...
class RadiotherapyTreatmentLocationQualifier(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-radiotherapy-treatment-location-qualifier-vs'
...
class TNMStageGroupStagingType(CodedConcept):
    canonical_url =  'https://build.fhir.org/ig/HL7/fhir-mCODE-ig/ValueSet-mcode-tnm-stage-group-staging-type-vs.json'
...
class CancerStagingType(CodedConcept):
    canonical_url = 'http://hl7.org/fhir/us/mcode/ValueSet/mcode-observation-codes-stage-group-vs'
...
class CancerStagingMethod(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-cancer-staging-method-vs'
...
class TNMStageClassification(CodedConcept):
    canonical_url =  'https://build.fhir.org/ig/HL7/fhir-mCODE-ig/ValueSet-mcode-tnm-stage-group-vs.json'
...
class TNMStagingMethod(CodedConcept):
    canonical_url =  'https://build.fhir.org/ig/HL7/fhir-mCODE-ig/ValueSet-mcode-tnm-staging-method-vs.json'
...
class TNMPrimaryTumorCategory(CodedConcept):
    canonical_url =  'https://pop.org/fhir/ValueSets/pop-tnm-primary-tumor-category'
...
class TNMPrimaryTumorStagingType(CodedConcept):
    canonical_url =  'https://build.fhir.org/ig/HL7/fhir-mCODE-ig/ValueSet-mcode-tnm-primary-tumor-staging-type-vs.json'
...
class TNMDistantMetastasesCategory(CodedConcept):
    canonical_url =  'https://pop.org/fhir/ValueSets/pop-tnm-distant-metastases-category'
...
class TNMDistantMetastasesStagingType(CodedConcept):
    canonical_url =  'https://build.fhir.org/ig/HL7/fhir-mCODE-ig/ValueSet-mcode-tnm-distant-metastases-staging-type-vs.json'
...
class TNMRegionalNodesCategoryValues(CodedConcept):
    canonical_url =  'https://pop.org/fhir/ValueSets/pop-tnm-regional-nodes-category'
...
class TNMRegionalNodesStagingType(CodedConcept):
    canonical_url =  'https://build.fhir.org/ig/HL7/fhir-mCODE-ig/ValueSet-mcode-tnm-regional-nodes-staging-type-vs.json'
...
class TNMGradeCategoryValues(CodedConcept):
    canonical_url =  'https://pop.org/fhir/ValueSets/pop-tnm-grade-category'
...
class TNMResidualTumorCategoryValues(CodedConcept):
    canonical_url =  'https://pop.org/fhir/ValueSets/pop-tnm-residual-tumor-category'
...
class TNMLymphaticInvasionCategoryValues(CodedConcept):
    canonical_url =  'https://pop.org/fhir/ValueSets/pop-tnm-lymphatic-invasion-category'
...
class TNMVenousInvasionCategoryValues(CodedConcept):
    canonical_url =  'https://pop.org/fhir/ValueSets/pop-tnm-venous-invasion-category'
...
class TNMPerineuralInvasionCategoryValues(CodedConcept):
    canonical_url =  'https://pop.org/fhir/ValueSets/pop-tnm-perineural-invasion-category'
...
class TNMSerumTumorMarkerLevelCategoryValues(CodedConcept):
    canonical_url =  'https://pop.org/fhir/ValueSets/pop-tnm-serum-tumor-marker-level-category'
...
class FIGOStageValue(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-figo-stage-value-vs'
...
class FIGOStagingMethod(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-figo-staging-method-vs'
...
class BinetStageValue(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-binet-stage-value-vs'
...
class RaiStageValue(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-rai-stage-value-vs'
...
class RaiStagingMethod(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-rai-staging-method-vs'
    description = 'Rai Staging Systems used to stage chronic lymphocytic leukemia (CLL).'


class LymphomaStageValue(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-lymphoma-stage-value-vs'
    description = 'Stage values used in lymphoma staging systems.'


class LymphomaStagingMethod(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-lymphoma-staging-method-vs'
...
class LymphomaStageValueModifier(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-lymphoma-stage-value-modifier-vs'
    description = 'Staging modifiers indicating symptoms and extent for lymphomas.'


class ClinOrPathModifier(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-clin-or-path-modifier-vs'
...
class BreslowDepthStageValue(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-breslow-depth-stage-value-vs'
    description = 'Codes in the Breslow staging system representing melanoma depth.'


class ClarkLevelValue(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-clark-level-value-vs'
    description = 'Levels for Clark staging of melanoma'


class MyelomaISSValue(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-myeloma-iss-stage-value-vs'
...
class MyelomaRISSValue(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-myeloma-riss-stage-value-vs'
...
class GleasonGradeGroupValue(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-gleason-grade-group-value-vs'
...
class TumorMarkerTestCodes(CodedConcept):
    canonical_url = 'https://pop.org/fhir/ValueSets/pop-tumor-marker-test-codes'
...
class RaceCategory(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/core/ValueSet/omb-race-category'
...
class BirthSex(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/core/ValueSet/birthsex'
...
class BodyLocationAndLateralityQualifier(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-body-location-and-laterality-qualifier-vs'
...
class UnitsOfTime(CodedConcept):
    canonical_url = 'http://hl7.org/fhir/ValueSet/units-of-time'
...
class USCoreSmokingStatusObservationCodes(CodedConcept):
    canonical_url =  'https://vsac.nlm.nih.gov/valueset/2.16.840.1.113883.11.20.9.38/expansion'
...
class CauseOfDeathCodes(CodedConcept):
    canonical_url =  'https://pop.org/fhir/ValueSets/pop-causes-of-death'
...
class TumorMorphologyCode(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-tumor-morphology-code-vs'
    description = 'Contains the preferred preferred (active) code for tumor morphology.'

 

class TumorSizeMethod(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-tumor-size-method-vs'
...
class MeasurementSetting(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/vitals/ValueSet/MeasSettingVS'
...
class AdverseEventExpectation(CodedConcept):
    canonical_url =  'https://build.fhir.org/ig/standardhealth/fsh-ae/ValueSet-adverse-event-expectation-value-set.json'
...
class AdverseEventSeriousnessOutcome(CodedConcept):
    canonical_url =  'https://build.fhir.org/ig/standardhealth/fsh-ae/ValueSet-adverse-event-seriousness-outcome-value-set.json'
    description = 'The outcome of a serious adverse event'


class AdverseEventSeriousness(CodedConcept):
    canonical_url =  'https://build.fhir.org/ig/standardhealth/fsh-ae/ValueSet-adverse-event-seriousness-value-set.json'
    description = 'An adverse event is classified as serious or non-serious.'


class CTCAETerms(CodedConcept):
    canonical_url =  'artifacts/CTCAE_v5.0.xlsx'
...
class AdverseEventRelatedness(CodedConcept):
    canonical_url =  'https://build.fhir.org/ig/standardhealth/fsh-ae/ValueSet-adverse-event-relatedness-value-set.json'
...
class HighLowCodes(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/uv/genomics-reporting/ValueSet/high-low-codes-vs'
...
class GeneticVariantAssessment(CodedConcept):
    canonical_url =  'https://loinc.org/LL1971-2/'
    description = 'Genetic variant assessment codes'


class StructuralVariantAnalysisMethods(CodedConcept):
    canonical_url =  'https://loinc.org/LL4048-6/'
    description = 'Structural variant analysis methods'


class HGNC(CodedConcept):
    canonical_url =  'https://biomart.genenames.org'
    description = 'HUGO Gene Nomenclature Committee Gene Names (HGNC)'
    chromosomeLocation = models.CharField(
         verbose_name=_('Chromosome location'),
        help_text=_('Cytogenetic location'),
        max_length=50,
    )
    alias = models.CharField(     
         verbose_name=_('Alias(es)'),
        help_text=_('Gene alias(es)'),
        max_length=200,
        null=True,
    )
    previous = models.CharField(
         verbose_name=_('Old alias(es)'),
        help_text=_('Previous alias(es)'),
        max_length=200,
        null=True,
    )
    refseq = models.CharField(
         verbose_name=_('RefSeq'),
        help_text=_('Reference sequence'),
        max_length=200,
        null=True,
    )
...
class GeneticTherapeuticImplications(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/uv/genomics-reporting/ValueSet/genetic-therapeutic-implications-vs'
...
class TreatmentCategories(CodedConcept):
    canonical_url =  'https://pop.org/fhir/ValueSets/pop-treatment-categories'
...
class CancerTreatmentResponseObservationMethods(CodedConcept):
    canonical_url =  'https://pop.org/fhir/ValueSets/pop-cancer-treatment-response-observation-methods'
...
class TreatmentResponseInterpretation(CodedConcept):
    canonical_url =  'https://pop.org/fhir/ValueSets/pop-treatment-response-interpretations'
...
class PDL1ImmuneCellScores(CodedConcept):
    canonical_url =  'https://pop.org/fhir/ValueSets/pop-pdl1-immune-cell-scores'
...
class HistoryOfMetastaticMalignantNeoplasm(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/us/mcode/ValueSet/mcode-history-of-metastatic-malignant-neoplasm-vs'
...
class MedicationRequestIntent(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/ValueSet/medicationrequest-intent'
    description = 'Intent for a given medication request.'


class MedicationRequestCategory(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/ValueSet/medicationrequest-category'
    description = 'Category of a given medication request.'


class DoseAndRateType(CodedConcept):
    canonical_url =  'http://terminology.hl7.org/CodeSystem/dose-rate-type'
    description = 'The kind of dose or rate specified.'


class HumanSpecimenType(CodedConcept):
    canonical_url =  'https://build.fhir.org/ig/HL7/fhir-mCODE-ig/ValueSet-mcode-human-specimen-type-vs.json'
...
class AdverseEventActuality(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/ValueSet/adverse-event-actuality'
    description = 'Overall nature of the adverse event, e.g. real or potential.'


class CTCAEGrade(CodedConcept):
    canonical_url =  'https://build.fhir.org/ig/standardhealth/fsh-ae/CodeSystem-ctcae-grade-code-system.json'
...
class AdverseEventSeverity(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/ValueSet/adverse-event-severity'
...
class AdverseEventOutcome(CodedConcept):
    canonical_url =  'http://hl7.org/fhir/ValueSet/adverse-event-outcome'
    description = 'N/A'


class ResearchStudyPhase(CodedConcept):
    canonical_url = 'http://hl7.org/fhir/ValueSet/research-study-phase'
...
class AdverseEventMitigationTreatmentAdjustment(CodedConcept):
    canonical_url = 'https://pop.org/fhir/ValueSets/pop-adverse-event-mitigation-treatment-adjustment'
...
class AdverseEventMitigationDrugs(CodedConcept):
    canonical_url = 'https://pop.org/fhir/ValueSets/pop-adverse-event-mitigation-drugs'
...
class AdverseEventMitigationProcedures(CodedConcept):
    canonical_url = 'https://pop.org/fhir/ValueSets/pop-adverse-event-mitigation-procedures'
...
class AdverseEventMitigationManagement(CodedConcept):
    canonical_url = 'https://pop.org/fhir/ValueSets/pop-adverse-event-mitigation-management'
...
class CancerRiskAssessmentMethods(CodedConcept):
    canonical_url = 'https://pop.org/fhir/ValueSets/pop-cancer-risk-assessment-methods'
    description = "Methods used to assess the risk in cancer"

class CancerRiskAssessmentValues(CodedConcept):
    canonical_url = 'https://pop.org/fhir/ValueSets/pop-cancer-risk-assessment-values'
