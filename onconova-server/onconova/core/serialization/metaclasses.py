...
from onconova.core.anonymization import AnonymizationConfig, AnonymizationMixin
from onconova.core.models import BaseModel as OrmBaseModel
from onconova.core.serialization.base import BaseSchema
from onconova.core.serialization.factory import create_schema
...
GET_SCHEMA_FIELDS = (
    (
        "description",
        str,
        Field(title="Description", description="Human-readable description"),
    ),
)
