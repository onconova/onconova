    ...
    operations = [
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "oncology_radiotherapyevent" ("case_id", "external_source", "external_source_id", "intent", "period", "pgh_context", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "sessions", "termination_reason_id") VALUES (NEW."case_id", NEW."external_source", NEW."external_source_id", NEW."intent", NEW."period", COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_metadata\', TRUE), \'\'), NULL)::JSONB, COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_id\', TRUE), \'\'), NULL)::UUID, NOW(), \'create\', NEW."id", NEW."sessions", NEW."termination_reason_id"); RETURN NULL;',
                    hash="22e67407d1427807d70c921ea74b447fdd4a8fb9",
                    operation="INSERT",
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                name="update_update",
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    condition='WHEN (OLD."case_id" IS DISTINCT FROM (NEW."case_id") OR OLD."external_source" IS DISTINCT FROM (NEW."external_source") OR OLD."external_source_id" IS DISTINCT FROM (NEW."external_source_id") OR OLD."intent" IS DISTINCT FROM (NEW."intent") OR OLD."period" IS DISTINCT FROM (NEW."period") OR OLD."sessions" IS DISTINCT FROM (NEW."sessions") OR OLD."termination_reason_id" IS DISTINCT FROM (NEW."termination_reason_id"))',
                    func='INSERT INTO "oncology_radiotherapyevent" ("case_id", "external_source", "external_source_id", "intent", "period", "pgh_context", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "sessions", "termination_reason_id") VALUES (NEW."case_id", NEW."external_source", NEW."external_source_id", NEW."intent", NEW."period", COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_metadata\', TRUE), \'\'), NULL)::JSONB, COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_id\', TRUE), \'\'), NULL)::UUID, NOW(), \'update\', NEW."id", NEW."sessions", NEW."termination_reason_id"); RETURN NULL;',
                    hash="6022fd6346f636b9ce2b79242c2da563b97ea675",
                    operation="UPDATE",
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash="9e55c7d3b631fca9fb4ae4f9dbfa8a176e77193d",
                    operation="DELETE",
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash="57ec3d34ef90a1ffff1f825d09a0a951265c0ee4",
                    operation="INSERT",
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                name="update_update",
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    condition='WHEN (OLD."bodysite_id" IS DISTINCT FROM (NEW."bodysite_id") OR OLD."bodysite_laterality_id" IS DISTINCT FROM (NEW."bodysite_laterality_id") OR OLD."bodysite_qualifier_id" IS DISTINCT FROM (NEW."bodysite_qualifier_id") OR OLD."case_id" IS DISTINCT FROM (NEW."case_id") OR OLD."date" IS DISTINCT FROM (NEW."date") OR OLD."external_source" IS DISTINCT FROM (NEW."external_source") OR OLD."external_source_id" IS DISTINCT FROM (NEW."external_source_id") OR OLD."intent" IS DISTINCT FROM (NEW."intent") OR OLD."outcome_id" IS DISTINCT FROM (NEW."outcome_id") OR OLD."procedure_id" IS DISTINCT FROM (NEW."procedure_id"))',
                    func='INSERT INTO "oncology_surgeryevent" ("bodysite_id", "bodysite_laterality_id", "bodysite_qualifier_id", "case_id", "date", "external_source", "external_source_id", "intent", "outcome_id", "pgh_context", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "procedure_id") VALUES (NEW."bodysite_id", NEW."bodysite_laterality_id", NEW."bodysite_qualifier_id", NEW."case_id", NEW."date", NEW."external_source", NEW."external_source_id", NEW."intent", NEW."outcome_id", COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_metadata\', TRUE), \'\'), NULL)::JSONB, COALESCE(NULLIF(CURRENT_SETTING(\'pghistory.context_id\', TRUE), \'\'), NULL)::UUID, NOW(), \'update\', NEW."id", NEW."procedure_id"); RETURN NULL;',
                    hash="42dcd708567345ee77f018930137aa0232999aa1",
                    operation="UPDATE",
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash="7079f5a411282c459eb27e2ff517d00b53575570",
                    operation="DELETE",
