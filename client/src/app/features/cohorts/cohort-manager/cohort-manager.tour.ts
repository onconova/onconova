...
const TourDriverConfig: Config = {
    showProgress: true,
    steps: [
        { element: '.onconova-cohort-manager-header', popover: { 
        ...
        { element: '.onconova-cohort-manager-summary', popover: { 
            side: "right", align: 'start', 
        ...
        { element: 'onconova-cohort-query-builder:nth-of-type(1)', popover: { 
        ...
        { element: '.onconova-cohort-manager-tabs .p-tab:nth-of-type(1)', popover: { 
            side: "top", align: 'center', 
            title: "Cohort Composition",
            ...
            onNextClick: (el, step, {config, state, driver}) => {
                const element = document.querySelector('.onconova-cohort-manager-tabs .p-tab:nth-of-type(1)') as HTMLElement;
                if (element) {
                    element.click();
                }
                driver.moveNext()
        ...
        { element: '.p-tabpanels', popover: { 
            ...
            onNextClick: (el, step, {config, state, driver}) => {
                const element = document.querySelector('.onconova-cohort-manager-tabs .p-tab:nth-of-type(2)') as HTMLElement;
                if (element) {
                    element.click();
                }
                driver.moveNext()
        ...
        { element: '.onconova-cohort-manager-tabs .p-tab:nth-of-type(2)', popover: { 
            side: "top", align: 'center', 
        ...
        { element: '.p-tabpanels canvas:nth-of-type(1)', popover: { 
            ...
            onNextClick: (el, step, {config, state, driver}) => {
                const element = document.querySelector('.onconova-cohort-manager-tabs .p-tab:nth-of-type(3)') as HTMLElement;
                if (element) {
                    element.click();
                }
                driver.moveNext()
        ...
        { element: '.onconova-cohort-manager-tabs .p-tab:nth-of-type(3)', popover: { 
            side: "top", align: 'center', 
            title: "Datasets",
        ...
        { element: '.dataset-download-button', popover: { 
            ...
            onNextClick: (el, step, {config, state, driver}) => {
                const element = document.querySelector('.onconova-cohort-manager-tabs .p-tab:nth-of-type(4)') as HTMLElement;
                if (element) {
                    element.click();
                }
                driver.moveNext()
        ...
        { element: '.onconova-cohort-manager-tabs .p-tab:nth-of-type(4)', popover: { 
            side: "top", align: 'center', 
            title: "Contributors",
            description: 'A ranking of contributors to the data contained in this cohort.', 
            onNextClick: (el, step, {config, state, driver}) => {
                const element = document.querySelector('.onconova-cohort-manager-tabs .p-tab:nth-of-type(5)') as HTMLElement;
                if (element) {
                    element.click();
                }
                driver.moveNext()
        ...
        { element: '.onconova-cohort-manager-tabs .p-tab:nth-of-type(5)', popover: { 
            side: "top", align: 'center', 
            title: "History",
