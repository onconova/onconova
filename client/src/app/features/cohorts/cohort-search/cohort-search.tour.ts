...
const TourDriverConfig: Config = {
    ...
    steps: [
        ...
        { element: 'onconova-cohort-search-item:nth-of-type(1)', popover: { 
        ...
        { element: 'onconova-cohort-search-item:nth-of-type(1) .p-splitbutton-button', popover: { 
            side: "right", align: 'center', 
            ...
            onNextClick: (el, step, {config, state, driver}) => {
                const element = document.querySelector('onconova-cohort-search-item:nth-of-type(1) .p-splitbutton-dropdown') as HTMLElement;
                if (element) {
                    element.click();
                }
                setTimeout(() => {
        ...
        { element: 'onconova-cohort-search-item:nth-of-type(1) .p-tieredmenu-item.export-action', popover: { 
            side: "right", align: 'center', 
        ...
        { element: 'onconova-cohort-search-item:nth-of-type(1) .p-tieredmenu-item.delete-action', popover: { 
            side: "right", align: 'center', 
