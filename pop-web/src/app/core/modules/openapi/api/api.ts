...
export const APIS = [AuthService, MeasuresService, NeoplasticEntitiesService, PatientCasesService, RiskAssessmentsService, StagingsService, TerminologyService, TumorMarkersService];
